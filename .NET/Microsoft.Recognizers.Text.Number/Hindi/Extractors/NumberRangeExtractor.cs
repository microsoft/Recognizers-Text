    ...
    public class NumberRangeExtractor : BaseNumberRangeExtractor
    {
                  ...
                  config)
        {
            var regexes = new Dictionary<Regex, string>()
            {
                ...
                {
                    // 30 and/or greater/higher
                    new Regex(NumbersDefinitions.OneNumberRangeMoreRegex0, RegexFlags, RegexTimeOut),
                    NumberRangeConstants.MORE
                },
                {
                    // less/smaller/lower than ...
                    new Regex(NumbersDefinitions.OneNumberRangeLessRegex0, RegexFlags, RegexTimeOut),
                    NumberRangeConstants.LESS
                },
            };
