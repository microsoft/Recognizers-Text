    ...
    public class NumberRecognizer : Recognizer<NumberOptions>
    {
        ...
        protected override List<Type> GetRelatedTypes()
        {
            return new List<Type>()
            {
                ...
                typeof(ArabicNumberRangeParserConfiguration),
                typeof(ChineseNumberRangeParserConfiguration),
                typeof(DutchNumberRangeParserConfiguration),
                typeof(EnglishNumberRangeParserConfiguration),
                typeof(FrenchNumberRangeParserConfiguration),
                typeof(GermanNumberRangeParserConfiguration),
                typeof(HindiNumberRangeParserConfiguration),
                typeof(ItalianNumberRangeParserConfiguration),
                typeof(JapaneseNumberRangeParserConfiguration),
                typeof(KoreanNumberRangeParserConfiguration),
                typeof(PortugueseNumberRangeParserConfiguration),
                typeof(SpanishNumberRangeParserConfiguration),
                typeof(SwedishNumberRangeParserConfiguration),
                typeof(TurkishNumberRangeParserConfiguration),
            };
        }
