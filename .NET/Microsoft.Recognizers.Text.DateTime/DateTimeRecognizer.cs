    ...
    public class DateTimeRecognizer : Recognizer<DateTimeOptions>
    {
        ...
        protected override void InitializeConfiguration()
        {
            ...
            RegisterModel<DateTimeModel>(
                ...
                options => new DateTimeModel(
                    new BaseMergedDateTimeParser(
                        new ItalianMergedParserConfiguration(new BaseOptionsConfiguration(options, dmyDateFormat: true))),
                    new BaseMergedDateTimeExtractor(
                        new ItalianMergedExtractorConfiguration(new BaseOptionsConfiguration(options, dmyDateFormat: true)))));
