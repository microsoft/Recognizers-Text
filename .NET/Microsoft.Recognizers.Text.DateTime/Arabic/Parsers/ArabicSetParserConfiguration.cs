...
{
    public class ArabicSetParserConfiguration : BaseDateTimeOptionsConfiguration, ISetParserConfiguration
    {
            ...
            : base(config)
        {
            ...
            EachPrefixRegex = ArabicSetExtractorConfiguration.EachPrefixRegex;
            PeriodicRegex = ArabicSetExtractorConfiguration.PeriodicRegex;
            EachUnitRegex = ArabicSetExtractorConfiguration.EachUnitRegex;
            EachDayRegex = ArabicSetExtractorConfiguration.EachDayRegex;
            SetWeekDayRegex = ArabicSetExtractorConfiguration.SetWeekDayRegex;
            SetEachRegex = ArabicSetExtractorConfiguration.SetEachRegex;
        }
