...
{
    public class ArabicDateTimeParserConfiguration : BaseDateTimeOptionsConfiguration, IDateTimeParserConfiguration
    {
         ...
         : base(config)
        {
            ...
            SimpleTimeOfTodayAfterRegex = ArabicDateTimeExtractorConfiguration.SimpleTimeOfTodayAfterRegex;
            SimpleTimeOfTodayBeforeRegex = ArabicDateTimeExtractorConfiguration.SimpleTimeOfTodayBeforeRegex;
            SpecificTimeOfDayRegex = ArabicDateTimeExtractorConfiguration.SpecificTimeOfDayRegex;
            SpecificEndOfRegex = ArabicDateTimeExtractorConfiguration.SpecificEndOfRegex;
            UnspecificEndOfRegex = ArabicDateTimeExtractorConfiguration.UnspecificEndOfRegex;
            UnitRegex = ArabicTimeExtractorConfiguration.TimeUnitRegex;
            DateNumberConnectorRegex = ArabicDateTimeExtractorConfiguration.DateNumberConnectorRegex;
            YearRegex = ArabicDateTimeExtractorConfiguration.YearRegex;
