...
{
    public class ArabicHolidayParserConfiguration : BaseHolidayParserConfiguration
    {
            ...
            : base(config)
        {
            ...
            this.HolidayRegexList = ArabicHolidayExtractorConfiguration.HolidayRegexList;
