...
{
    public class KoreanMergedExtractorConfiguration : BaseDateTimeOptionsConfiguration, IMergedExtractorConfiguration
    {
            ...
            : base(config)
        {
            ...
            SetExtractor = new BaseSetExtractor(new KoreanSetExtractorConfiguration(this));
            HolidayExtractor = new BaseHolidayExtractor(new KoreanHolidayExtractorConfiguration(this));

            TimeZoneExtractor = new BaseTimeZoneExtractor(new KoreanTimeZoneExtractorConfiguration(this));
            DateTimeAltExtractor = new BaseDateTimeAltExtractor(new KoreanDateTimeAltExtractorConfiguration(this));
            ...
            IntegerExtractor = new Number.Korean.IntegerExtractor(mode);
