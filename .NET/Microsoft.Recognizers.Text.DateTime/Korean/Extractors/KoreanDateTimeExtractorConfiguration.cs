...
{
    public class KoreanDateTimeExtractorConfiguration : BaseDateTimeOptionsConfiguration, IDateTimeExtractorConfiguration
    {
            ...
            : base(config)
        {
            ...
            DatePointExtractor = new BaseDateExtractor(new KoreanDateExtractorConfiguration(this));
            TimePointExtractor = new BaseTimeExtractor(new KoreanTimeExtractorConfiguration(this));
