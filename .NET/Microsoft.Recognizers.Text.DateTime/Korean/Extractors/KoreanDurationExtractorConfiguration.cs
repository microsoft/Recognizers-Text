...
{
    public class KoreanDurationExtractorConfiguration : BaseDateTimeOptionsConfiguration, IDurationExtractorConfiguration
    {
        ...
        public KoreanDurationExtractorConfiguration(IDateTimeOptionsConfiguration config)
            : base(config)
        {
