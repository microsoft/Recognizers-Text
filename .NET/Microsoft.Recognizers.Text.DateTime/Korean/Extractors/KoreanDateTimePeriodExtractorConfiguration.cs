...
namespace Microsoft.Recognizers.Text.DateTime.Korean
{
        ...
        IDateTimePeriodExtractorConfiguration
    {
        ...
        {
            KoreanTimePeriodExtractorConfiguration.PureNumFromTo,
            KoreanTimePeriodExtractorConfiguration.PureNumBetweenAnd,
        };
            ...
            : base(config)
        {
            ...
            Number.Korean.KoreanNumberExtractorMode mode = Number.Korean.KoreanNumberExtractorMode.Default;

            CardinalExtractor = new Number.Korean.CardinalExtractor(mode);

            SingleDateExtractor = new BaseDateExtractor(new KoreanDateExtractorConfiguration(this));
            SingleTimeExtractor = new BaseTimeExtractor(new KoreanTimeExtractorConfiguration(this));
            SingleDateTimeExtractor = new BaseDateTimeExtractor(new KoreanDateTimeExtractorConfiguration(this));
            ...
            TimeZoneExtractor = new BaseTimeZoneExtractor(new KoreanTimeZoneExtractorConfiguration(this));
        }

        public IEnumerable<Regex> SimpleCasesRegex => SimpleCases;

        public Regex PrepositionRegex => KoreanTimePeriodExtractorConfiguration.PrepositionRegex;

        public Regex TillRegex => KoreanTimePeriodExtractorConfiguration.TillRegex;

        public Regex TimeOfDayRegex => PeriodTimeOfDayRegex;

        public Regex SpecificTimeOfDayRegex => PeriodSpecificTimeOfDayRegex;

        public Regex PreviousPrefixRegex => KoreanDatePeriodExtractorConfiguration.PreviousPrefixRegex;

        public Regex NextPrefixRegex => KoreanDatePeriodExtractorConfiguration.NextPrefixRegex;

        public Regex FutureSuffixRegex => KoreanDatePeriodExtractorConfiguration.FutureSuffixRegex;
