...
{
    public class KoreanTimePeriodParserConfiguration : BaseDateTimeOptionsConfiguration, ITimePeriodParserConfiguration
    {
        public KoreanTimePeriodParserConfiguration(ICommonDateTimeParserConfiguration config)
            : base(config)
        {
            ...
            SpecificTimeFromToRegex = KoreanTimePeriodExtractorConfiguration.SpecificTimeFromTo;
            SpecificTimeBetweenAndRegex = KoreanTimePeriodExtractorConfiguration.SpecificTimeBetweenAnd;
            TimeOfDayRegex = KoreanTimePeriodExtractorConfiguration.TimeOfDayRegex;
            GeneralEndingRegex = KoreanTimePeriodExtractorConfiguration.GeneralEndingRegex;
            TillRegex = KoreanTimePeriodExtractorConfiguration.TillRegex;
