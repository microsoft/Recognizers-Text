...
{
    public class KoreanDateParserConfiguration : BaseDateTimeOptionsConfiguration, IDateParserConfiguration
    {
        private const RegexOptions RegexFlags = RegexOptions.Singleline | RegexOptions.ExplicitCapture;

        public KoreanDateParserConfiguration(ICommonDateTimeParserConfiguration config)
             : base(config)
        {
            ...
            DateRegexes = new KoreanDateExtractorConfiguration(this).DateRegexList;
            OnRegex = KoreanDateExtractorConfiguration.OnRegex;
            ...
            NextRegex = KoreanDateExtractorConfiguration.NextDateRegex;
            ThisRegex = KoreanDateExtractorConfiguration.ThisRegex;
            LastRegex = KoreanDateExtractorConfiguration.LastDateRegex;
            UnitRegex = KoreanDateExtractorConfiguration.DateUnitRegex;
            WeekDayRegex = KoreanDateExtractorConfiguration.WeekDayRegex;
            MonthRegex = KoreanDateExtractorConfiguration.MonthRegex;
            WeekDayOfMonthRegex = KoreanDateExtractorConfiguration.WeekDayOfMonthRegex;
            ForTheRegex = KoreanDateExtractorConfiguration.ForTheRegex;
            WeekDayAndDayOfMothRegex = KoreanDateExtractorConfiguration.WeekDayAndDayOfMothRegex;
            ...
            StrictRelativeRegex = KoreanDateExtractorConfiguration.StrictRelativeRegex;
            YearSuffix = KoreanDateExtractorConfiguration.YearSuffix;
            RelativeWeekDayRegex = KoreanDateExtractorConfiguration.RelativeWeekDayRegex;
            BeforeAfterRegex = KoreanDateExtractorConfiguration.BeforeAfterRegex;
