...
{
    public class KoreanDateTimeParserConfiguration : BaseDateTimeOptionsConfiguration, IDateTimeParserConfiguration
    {
        ...
        public KoreanDateTimeParserConfiguration(ICommonDateTimeParserConfiguration config)
         : base(config)
        {
            ...
            SimpleTimeOfTodayAfterRegex = KoreanDateTimeExtractorConfiguration.SimpleTimeOfTodayAfterRegex;
            SimpleTimeOfTodayBeforeRegex = KoreanDateTimeExtractorConfiguration.SimpleTimeOfTodayBeforeRegex;
            SpecificTimeOfDayRegex = KoreanDateTimeExtractorConfiguration.SpecificTimeOfDayRegex;
            SpecificEndOfRegex = KoreanDateTimeExtractorConfiguration.SpecificEndOfRegex;
            UnspecificEndOfRegex = KoreanDateTimeExtractorConfiguration.UnspecificEndOfRegex;
            UnitRegex = KoreanTimeExtractorConfiguration.TimeUnitRegex;
            DateNumberConnectorRegex = KoreanDateTimeExtractorConfiguration.DateNumberConnectorRegex;
            YearRegex = KoreanDateTimeExtractorConfiguration.YearRegex;
