...
{
    public class KoreanSetParserConfiguration : BaseDateTimeOptionsConfiguration, ISetParserConfiguration
    {
        ...
        public KoreanSetParserConfiguration(ICommonDateTimeParserConfiguration config)
            : base(config)
        {
            ...
            PeriodicRegex = KoreanSetExtractorConfiguration.PeriodicRegex;
            EachUnitRegex = KoreanSetExtractorConfiguration.EachUnitRegex;
            EachDayRegex = KoreanSetExtractorConfiguration.EachDayRegex;
            SetWeekDayRegex = KoreanSetExtractorConfiguration.SetWeekDayRegex;
            SetEachRegex = KoreanSetExtractorConfiguration.SetEachRegex;
        }
