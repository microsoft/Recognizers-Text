...
{
    public class KoreanDateTimePeriodParserConfiguration : BaseDateTimeOptionsConfiguration, IDateTimePeriodParserConfiguration
    {
        ...
        public KoreanDateTimePeriodParserConfiguration(ICommonDateTimeParserConfiguration config)
            : base(config)
        {
            ...
            PureNumberFromToRegex = KoreanTimePeriodExtractorConfiguration.PureNumFromTo;
            HyphenDateRegex = KoreanDateTimePeriodExtractorConfiguration.HyphenDateRegex;
            PureNumberBetweenAndRegex = KoreanTimePeriodExtractorConfiguration.PureNumBetweenAnd;
            SpecificTimeOfDayRegex = KoreanDateTimePeriodExtractorConfiguration.PeriodSpecificTimeOfDayRegex;
            TimeOfDayRegex = KoreanDateTimeExtractorConfiguration.TimeOfDayRegex;
            PreviousPrefixRegex = KoreanDatePeriodExtractorConfiguration.PreviousPrefixRegex;
            ...
            NumberCombinedWithUnitRegex = KoreanDateTimePeriodExtractorConfiguration.TimeNumberCombinedWithUnit;
            UnitRegex = KoreanTimePeriodExtractorConfiguration.TimeUnitRegex;
            PeriodTimeOfDayWithDateRegex = KoreanDateTimePeriodExtractorConfiguration.PeriodTimeOfDayWithDateRegex;
            RelativeTimeUnitRegex = KoreanDateTimePeriodExtractorConfiguration.RelativeTimeUnitRegex;
            RestOfDateTimeRegex = KoreanDateTimePeriodExtractorConfiguration.RestOfDateTimeRegex;
            AmDescRegex = KoreanDateTimePeriodExtractorConfiguration.AmDescRegex;
            PmDescRegex = KoreanDateTimePeriodExtractorConfiguration.PmDescRegex;
            WithinNextPrefixRegex = KoreanDateTimePeriodExtractorConfiguration.WithinNextPrefixRegex;
            PrefixDayRegex = KoreanDateTimePeriodExtractorConfiguration.PrefixDayRegex;
            BeforeRegex = KoreanDateTimePeriodExtractorConfiguration.BeforeRegex;
            AfterRegex = KoreanDateTimePeriodExtractorConfiguration.AfterRegex;
