...
{
    public class KoreanHolidayParserConfiguration : BaseHolidayParserConfiguration
    {
        private const RegexOptions RegexFlags = RegexOptions.Singleline | RegexOptions.ExplicitCapture;

        public KoreanHolidayParserConfiguration(IDateTimeOptionsConfiguration config)
            : base(config)
        {
            ...
            this.HolidayRegexList = KoreanHolidayExtractorConfiguration.HolidayRegexList;
