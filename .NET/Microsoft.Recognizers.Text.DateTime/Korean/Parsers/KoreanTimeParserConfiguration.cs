...
{
    public class KoreanTimeParserConfiguration : BaseDateTimeOptionsConfiguration, ITimeParserConfiguration
    {
        ...
        public KoreanTimeParserConfiguration(ICommonDateTimeParserConfiguration config)
         : base(config)
        {
            TimeTokenPrefix = DateTimeDefinitions.TimeTokenPrefix;
            AtRegex = KoreanTimeExtractorConfiguration.AtRegex;
            TimeRegexes = KoreanTimeExtractorConfiguration.TimeRegexList;
        ...
        public void AdjustByPrefix(string prefix, ref int hour, ref int min, ref bool hasMin)
        {
            ...
            {
                var match = KoreanTimeExtractorConfiguration.LessThanOneHour.Match(trimmedPrefix);
