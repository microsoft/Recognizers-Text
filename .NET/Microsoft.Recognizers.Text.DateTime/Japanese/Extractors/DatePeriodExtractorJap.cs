...
{
    public class DatePeriodExtractorJap : IDateTimeExtractor
    {
        ...
        public static readonly Regex YearInJapaneseRegex = new Regex(DateTimeDefinitions.DatePeriodYearInJapaneseRegex, RegexOptions.IgnoreCase | RegexOptions.Singleline);
