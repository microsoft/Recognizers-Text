...
namespace Microsoft.Recognizers.Text.DateTime.Chinese
{
    public class DatePeriodExtractorChs : IDateTimeExtractor
    {
        ...
        public static readonly Regex YearToYearSuffixRequiredRegex = new Regex(DateTimeDefinitions.YearToYearSuffixRequiredRegex, RegexOptions.IgnoreCase | RegexOptions.Singleline);
        ...
        public static readonly Regex MonthToMonthSuffixRequiredRegex = new Regex(DateTimeDefinitions.MonthToMonthSuffixRequiredRegex, RegexOptions.IgnoreCase | RegexOptions.Singleline);
        ...
        private static readonly Regex[] SimpleCasesRegexes =
        {
            ...
            StrictYearRegex,
            YearToYear,
            YearToYearSuffixRequiredRegex,
            MonthToMonth,
            MonthToMonthSuffixRequiredRegex,
            YearAndMonth,
            PureNumYearAndMonth,
            YearInChineseRegex,
            WeekOfMonthRegex,
