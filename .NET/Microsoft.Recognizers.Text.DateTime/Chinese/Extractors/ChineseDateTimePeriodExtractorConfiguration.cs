...
namespace Microsoft.Recognizers.Text.DateTime.Chinese
{
        ...
        ICJKDateTimePeriodExtractorConfiguration
    {
            ...
            : base(config)
        {
            ...
            SingleDateExtractor = new BaseCJKDateExtractor(new ChineseDateExtractorConfiguration(this));
            SingleTimeExtractor = new BaseCJKTimeExtractor(new ChineseTimeExtractorConfiguration(this));
            SingleDateTimeExtractor = new BaseCJKDateTimeExtractor(new ChineseDateTimeExtractorConfiguration(this));
