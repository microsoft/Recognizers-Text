...
namespace Microsoft.Recognizers.Text.DateTime.Turkish
{
    public class TurkishDatePeriodParserConfiguration : BaseDateTimeOptionsConfiguration, IDatePeriodParserConfiguration
    {
            ...
            : base(config)
        {
            ...
            FirstLastRegex = TurkishDatePeriodExtractorConfiguration.FirstLastRegex;
            OfYearRegex = TurkishDatePeriodExtractorConfiguration.OfYearRegex;
        ...
        public bool IsYearOnly(string text)
        {
            ...
            return DateTimeDefinitions.YearTerms.Any(o => trimmedText.EndsWith(o, StringComparison.Ordinal)) ||
                   ...
                   (DateTimeDefinitions.GenericYearTerms.Any(o => trimmedText.EndsWith(o, StringComparison.Ordinal)) && UnspecificEndOfRangeRegex.IsMatch(trimmedText));
        }
