...
..\packages\NuGet.CommandLine.3.5.0\tools\NuGet.exe pack Microsoft.Recognizers.Text.DateTime.nuspec -symbols -properties version=%version%;basic=%basic%;number=%number%;numberWithUnit=%numberWithUnit% -OutputDirectory ..\nuget
