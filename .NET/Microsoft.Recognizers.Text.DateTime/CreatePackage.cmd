...
for /f %%v in ('powershell -noprofile "(Get-Command .\bin\release\net45\Microsoft.Recognizers.Text.NumberWithUnit.dll).FileVersionInfo.FileVersion"') do set numberWithUnit=%%v
for /f %%v in ('powershell -noprofile "(Get-Command .\bin\release\net45\Microsoft.Recognizers.Text.DateTime.dll).FileVersionInfo.FileVersion"') do set version=%%v
