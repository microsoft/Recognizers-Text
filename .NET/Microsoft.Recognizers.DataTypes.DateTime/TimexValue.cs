...
namespace Microsoft.Recognizers.DataTypes.DateTime
{
    ...
    {
        public static string DateValue(Timex obj)
        {
        ...
        public static string TimeValue(Timex obj)
        {
        ...
        public static string DatetimeValue(Timex obj)
        {
            return $"{DateValue(obj)} {TimeValue(obj)}";
        }

        public static string DurationValue(Timex obj)
        {
            if (obj.Years != null)
            {
