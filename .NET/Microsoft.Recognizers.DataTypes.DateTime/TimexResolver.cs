...
namespace Microsoft.Recognizers.DataTypes.DateTime
{
    public static class TimexResolver
    {
        ...
        private static List<Resolution.Entry> ResolveTimex(Timex timex, System.DateTime date)
        {
        ...
        private static List<Resolution.Entry> ResolveDefiniteTime(Timex timex)
        {
            return new List<Resolution.Entry>
            {
        ...
        private static List<Resolution.Entry> ResolveDefinite(Timex timex)
        {
            return new List<Resolution.Entry>
            {
                new Resolution.Entry
        ...
        private static List<Resolution.Entry> ResolveDate(Timex timex, System.DateTime date)
        {
            return new List<Resolution.Entry>
            {
                new Resolution.Entry
        ...
        private static string LastDateValue(Timex timex, System.DateTime date)
        {
            if (timex.Month != null && timex.DayOfMonth != null)
            {
                return TimexValue.DateValue(new Timex
                {
                    Year = date.Year - 1,
                    Month = timex.Month,
        ...
        private static string NextDateValue(Timex timex, System.DateTime date)
        {
            if (timex.Month != null && timex.DayOfMonth != null)
            {
                return TimexValue.DateValue(new Timex
        ...
        private static List<Resolution.Entry> ResolveTime(Timex timex)
        {
            return new List<Resolution.Entry>
            {
                new Resolution.Entry
        ...
        private static List<Resolution.Entry> ResolveDuration(Timex timex)
        {
            return new List<Resolution.Entry>
            {
                new Resolution.Entry
        ...
        private static Tuple<string, string> MonthDateRange(int year, int month) {
            return new Tuple<string, string>(
                TimexValue.DateValue(new Timex { Year = year, Month = month, DayOfMonth = 1 }),
                TimexValue.DateValue(new Timex { Year = year, Month = month + 1, DayOfMonth = 1 })
            );
        }

        private static List<Resolution.Entry> ResolveDateRange(Timex timex, System.DateTime date)
        {
        ...
        private static Tuple<string, string> PartOfDayTimeRange(Timex timex)
        {
        ...
        private static List<Resolution.Entry> ResolveTimeRange(Timex timex)
        {
        ...
        private static List<Resolution.Entry> ResolveDateTime(Timex timex, System.DateTime date)
        {
        ...
        private static List<Resolution.Entry> ResolveDateTimeRange(Timex timex)
        {
            if (timex.PartOfDay != null)
            {
