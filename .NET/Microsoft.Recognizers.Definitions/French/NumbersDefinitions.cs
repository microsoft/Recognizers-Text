...
namespace Microsoft.Recognizers.Definitions.French
{
	...
	public static class NumbersDefinitions
	{
		...
		public static readonly string AllIntRegex = $@"((NegativeNumberTermsRegex)?({SeparaIntRegex}|mille(\s+{BelowThousandsRegex})?))";
		...
		public static readonly string FractionPrepositionRegex = $@"(?<=\b)(({AllIntRegex})|((?<!\.)\d+))\s+sur\s+(({AllIntRegex})|((\d+)(?!\.)))(?=\b)";
