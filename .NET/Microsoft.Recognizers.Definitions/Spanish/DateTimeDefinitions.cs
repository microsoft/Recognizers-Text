...
namespace Microsoft.Recognizers.Definitions.Spanish
{
	...
	public static class DateTimeDefinitions
	{
		...
		public const string YearRegex = @"\b(?<year>(1[5-9]|20)\d{2})(?!\.0\b)\b";
		public const string TwoDigitYearRegex = @"\b(?<year>([0-27-9]\d)(?!\.0\b))\b";
		...
		public static readonly string DateExtractor2 = $@"\b({WeekDayRegex}(\s+|\s*,\s*))?{DayRegex}\s*([\.\-]|de)\s*{MonthRegex}(\s*,\s*|\s*(del?)\s*)({YearRegex}|{TwoDigitYearRegex})\b";
		public static readonly string DateExtractor3 = $@"\b({WeekDayRegex}(\s+|\s*,\s*))?{DayRegex}(\s+|\s*,\s*|\s+de\s+|\s*-\s*){MonthRegex}((\s+|\s*,\s*)({YearRegex}|{TwoDigitYearRegex}))?\b";
		public static readonly string DateExtractor4 = $@"\b{MonthNumRegex}\s*[/\\\-]\s*{DayRegex}\s*[/\\\-]\s*({YearRegex}|{TwoDigitYearRegex})";
		public static readonly string DateExtractor5 = $@"\b{DayRegex}\s*[/\\\-\.]\s*{MonthNumRegex}\s*[/\\\-\.]\s*({YearRegex}|{TwoDigitYearRegex})";
		public static readonly string DateExtractor6 = $@"(?<=\b(en|el)\s+){MonthNumRegex}[\-\.]{DayRegex}\b";
		public static readonly string DateExtractor7 = $@"\b{MonthNumRegex}\s*/\s*{DayRegex}((\s+|\s*,\s*|\s+de\s+)({YearRegex}|{TwoDigitYearRegex}))?\b";
		public static readonly string DateExtractor8 = $@"(?<=\b(en|el)\s+){DayRegex}[\\\-]{MonthNumRegex}\b";
		public static readonly string DateExtractor9 = $@"\b{DayRegex}\s*/\s*{MonthNumRegex}((\s+|\s*,\s*|\s+de\s+)({YearRegex}|{TwoDigitYearRegex}))?\b";
