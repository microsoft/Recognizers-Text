...
namespace Microsoft.Recognizers.Definitions.Chinese
{
	...
	public static class DateTimeDefinitions
	{
		...
		public const string DatePeriodTillSuffixRequired = @"(?<till>与|和)";
		...
		public static readonly string YearToYearSuffixRequired = $@"((从|在|自)\s*)?({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\s*({DatePeriodTillSuffixRequired})\s*({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\s*(之间|之内|期间|中间|间)";
		public static readonly string MonthToMonth = $@"({MonthRegex}){DatePeriodTillRegex}({MonthRegex})";
		public static readonly string MonthToMonthSuffixRequired = $@"({MonthRegex}){DatePeriodTillSuffixRequired}({MonthRegex})\s*(之间|之内|期间|中间|间)";
