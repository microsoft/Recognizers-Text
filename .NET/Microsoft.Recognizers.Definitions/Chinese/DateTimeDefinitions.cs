...
namespace Microsoft.Recognizers.Definitions.Chinese
{
	...
	public static class DateTimeDefinitions
	{
		...
		public const string DatePeriodThisRegex = @"这个|这一个|这|这一";
		...
		public static readonly string YearToYear = $@"({DatePeriodYearInChineseRegex}|{YearRegex}){DatePeriodTillRegex}({DatePeriodYearInChineseRegex}|{YearRegex})";
		...
		public const string ParserConfigurationBefore = @"(前|之前)$";
		public const string ParserConfigurationAfter = @"(后|之后)$";
