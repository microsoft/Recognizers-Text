...
namespace Microsoft.Recognizers.Definitions.Chinese
{
	...
	public static class DateTimeDefinitions
	{
		...
		public const string DatePeriodTillDependenceRegex = @"(?<till>与|和)";
		...
		public static readonly string YearToYearDependence = $@"((从|在|自)\s*)?({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\s*({DatePeriodTillDependenceRegex})\s*({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\s*(之间|之内|期间|中间|间)";
		public static readonly string MonthToMonth = $@"({MonthRegex}){DatePeriodTillRegex}({MonthRegex})";
		public static readonly string MonthToMonthDependence = $@"({MonthRegex}){DatePeriodTillDependenceRegex}({MonthRegex})\s*(之间|之内|期间|中间|间)";
