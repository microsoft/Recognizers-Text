...
namespace Microsoft.Recognizers.Definitions.Chinese
{
	...
	public static class DateTimeDefinitions
	{
		...
		public const string AfterRegex = @"以后|之后|后|以後|之後|後";
		...
		public static readonly string YearToYear = $@"({DateRangePrepositions})({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\s*({DatePeriodTillRegex}|后|之后|後|之後)\s*({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})(\s*((之间|之内|期间|中间|间)|前|之前))?";
