...
namespace Microsoft.Recognizers.Definitions.German
{
	...
	public static class DateTimeDefinitions
	{
		...
		public static readonly string HolidayRegex2 = $@"\b((dieses jahr)\s*)?(?<holiday>martin luther king|martin luther king jr|allerheiligen|tree planting day|white lover|st patrick|st george|independence|us independence|allerheiligen|allerseelen|guy fawkes|silvester|weiberfastnacht|karneval|aschermittwoch|palmensonntag|karfreitag|christi himmelfahrt|pfingstsonntag|pfingstmontag|fronleichnam|rosenmontag|fastnacht|gründonnerstag|himmelfahrt|volkstrauertag|buß und bettag|buß\- und bettag|totensonntag|erster advent|1\. advent|zweiter advent|2\. Advent|dritter advent|3\. advent|vierter advent|4\. advent|schweizer buß und bettag|schweizer buß\- und bettag)(\s+((diesen)\s+)?({YearRegex}|{RelativeRegex}\s+jahres))?\b";
