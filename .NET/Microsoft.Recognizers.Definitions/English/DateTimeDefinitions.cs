...
namespace Microsoft.Recognizers.Definitions.English
{
	...
	public static class DateTimeDefinitions
	{
		...
		public const string PmRegex = @"(?<pm>((in the\s+)?afternoon)|((in the\s+)?evening)|((in the\s+)?(night|dinner)))";
		public const string AmRegex = @"(?<am>(in the\s+)?(morning|breakfast|lunchtime|lunch))";
