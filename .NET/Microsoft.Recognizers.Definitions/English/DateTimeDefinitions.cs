...
namespace Microsoft.Recognizers.Definitions.English
{
	...
	public static class DateTimeDefinitions
	{
		...
		public static readonly string MonthNumWithYear = $@"\b(({FourDigitYearRegex}(\s*)[/\-\.](\s*){MonthNumRegex})|({MonthNumRegex}(\s*)[/\-](\s*){FourDigitYearRegex}))\b";
		...
		public static readonly string DateYearRegex = $@"(?<year>{FourDigitYearRegex}|{TwoDigitYearRegex})";
