...
namespace Microsoft.Recognizers.Definitions.English
{
	...
	public static class DateTimeDefinitions
	{
		...
		public static readonly string MonthWithYear = $@"\b(({EngMonthRegex}(\s+)?,?(\s+of)?\s+({YearRegex}|(?<order>next|last|this)\s+year))|(({YearRegex}|(?<order>next|last|this)\s+year)\s*,?\s+{EngMonthRegex}))\b";
