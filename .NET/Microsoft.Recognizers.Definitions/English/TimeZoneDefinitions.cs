...
namespace Microsoft.Recognizers.Definitions.English
{
	...
	public static class TimeZoneDefinitions
	{
		...
		public static readonly Dictionary<string, int> full2Minute = new Dictionary<string, int>
		{
			{ "beijing time", 480 },
			{ "shanghai time", 480 },
			{ "shenzhen time", 480 },
