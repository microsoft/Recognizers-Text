...
namespace Microsoft.Recognizers.Definitions.English
{
	...
	public static class NumbersDefinitions
	{
		...
		public const string NegativeNumberTermsRegex = @"(minus|negative)";
		...
		public static readonly string AllIntRegex = $@"(({NegativeNumberTermsRegex}\s+)?(((({TenToNineteenIntegerRegex}|({TensNumberIntegerRegex}(\s+(and\s+)?|\s*-\s*){ZeroToNineIntegerRegex})|{TensNumberIntegerRegex}|{ZeroToNineIntegerRegex}|{AnIntRegex})(\s+{RoundNumberIntegerRegex})+)\s+(and\s+)?)*{SeparaIntRegex}))";
