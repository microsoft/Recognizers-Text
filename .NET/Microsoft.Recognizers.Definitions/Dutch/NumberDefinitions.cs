...
namespace Microsoft.Recognizers.Definitions.Dutch
{
	...
	public static class NumbersDefinitions
	{
		...
		public static readonly string AllIntRegex = $@"(((({TenToNineteenIntegerRegex}|({TensNumberIntegerRegex}(\s+(en\s+)?|\s*-\s*){ZeroToNineIntegerRegex})|{TensNumberIntegerRegex}|{ZeroToNineIntegerRegex}|{AnIntRegex})(\s+{RoundNumberIntegerRegex})+)\s+(en\s+)?)*{SeparaIntRegex})";
		...
		public static readonly string AllIntRegexWithDozenSuffixLocks = $@"(?<=\b)(((half\s+)?\s+dozijn)|({AllIntRegex}\s+dozijn(en)?))(?=\b)";
		...
		public static readonly string SuffixBasicOrdinalRegex = $@"((((({TensNumberIntegerRegex}(\s+(en\s+)?|\s*-\s*){ZeroToNineIntegerRegex})|{TensNumberIntegerRegex}|{ZeroToNineIntegerRegex}|{AnIntRegex})(\s+{RoundNumberIntegerRegex})+)\s+(en\s+)?)*({TensNumberIntegerRegex}(\s+|\s*-\s*))?{BasicOrdinalRegex})";
		...
		public static readonly string OrdinalRoundNumberRegex = $@"(?<!(de|een)\s+){RoundNumberOrdinalRegex}";
		...
		public static readonly string FractionNounWithArticleRegex = $@"(?<=\b)({AllIntRegex}\s+(en\s+)?)?(een)(\s+|\s*-\s*)(?!\beerste\b|\btweede\b)(({AllOrdinalRegex})|({RoundNumberOrdinalRegex})|half|vierde)(?=\b)";
