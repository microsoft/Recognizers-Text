...
namespace Microsoft.Recognizers.Text.DataTypes.TimexExpression.Tests
{
    ...
    public class TestTimexRangeResolve
    {
        ...
        public void DataTypes_RangeResolve_daterange_definite()
        {
            ...
            var constraints = new[] { (new TimexProperties { Year = 2017, Month = 9, DayOfMonth = 27, Days = 2 }).TimexValue };
        ...
        public void DataTypes_RangeResolve_daterange_month_and_date()
        {
            ...
            var constraints = new[] { (new TimexProperties { Year = 2006, Month = 1, DayOfMonth = 1, Years = 2 }).TimexValue };
        ...
        public void DataTypes_RangeResolve_timerange_time_within_range()
        {
            ...
            var constraints = new[] { (new TimexProperties { Hour = 14, Hours = 4 }).TimexValue };
        ...
        {
            var constraints = new List<string> { (new TimexProperties { Hour = 16, Hours = 4 }).TimexValue };
            ...
            constraints.Add((new TimexProperties { Hour = 14, Hours = 4 }).TimexValue);
        ...
        public void DataTypes_RangeResolve_carry_through_time_definite()
        {
            ...
            {
                (new TimexProperties { Year = 2017, Month = 9, DayOfMonth = 27, Days = 2 }).TimexValue
            };
        ...
        public void DataTypes_RangeResolve_carry_through_time_month_and_date()
        {
            var constraints = new List<string>
            {
                (new TimexProperties { Year = 2006, Month = 1, DayOfMonth = 1, Years = 2 }).TimexValue
            };
        ...
        public void DataTypes_RangeResolve_combined_daterange_and_timerange_next_week_and_any_time()
        {
            var constraints = new List<string>
            {
                (new TimexProperties { Year = 2017, Month = 10, DayOfMonth = 5, Days = 7 }).TimexValue,
                (new TimexProperties { Hour = 0, Minute = 0, Second = 0, Hours = 24 }).TimexValue
            };
        ...
        public void DataTypes_RangeResolve_combined_daterange_and_timerange_next_week_and_business_hours()
        {
            ...
            {
                (new TimexProperties { Year = 2017, Month = 10, DayOfMonth = 5, Days = 7 }).TimexValue,
                (new TimexProperties { Hour = 12, Minute = 0, Second = 0, Hours = 8 }).TimexValue
            };
