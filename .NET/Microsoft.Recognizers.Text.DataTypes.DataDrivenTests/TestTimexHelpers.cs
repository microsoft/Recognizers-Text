...
namespace Microsoft.Recognizers.Text.DataTypes.TimexExpression.Tests
{
    ...
    public class TestTimexHelpers
    {
        ...
        {
            var timex = new TimexProperties("(2017-09-27,2017-09-29,P2D)");
        ...
        {
            var timex = new TimexProperties("(2006-01-01,2008-06-01,P882D)");
            var range = TimexHelpers.ExpandDateTimeRange(timex);
        ...
        {
            var timex = new TimexProperties("(2017-10-10T16:02:04,2017-10-10T16:07:04,PT5M)");
            var range = TimexHelpers.ExpandDateTimeRange(timex);
        ...
        {
            var timex = new TimexProperties("2017-05");
            var range = TimexHelpers.ExpandDateTimeRange(timex);
        ...
        {
            var timex = new TimexProperties("1999");
            var range = TimexHelpers.ExpandDateTimeRange(timex);
        ...
        {
            var timex = new TimexProperties("(T14,T16,PT2H)");
        ...
        {
            var timex = new TimexProperties("T00:05:00");
