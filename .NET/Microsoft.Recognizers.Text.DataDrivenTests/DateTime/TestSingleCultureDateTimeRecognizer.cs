...
namespace Microsoft.Recognizers.Text.DateTime.Tests
{
    ...
    public class TestSingleCultureDateTimeRecognizer
    {
        ...
        public void BasicTest(string text, string expected)
        {
            ...
            var values = pr[0].Resolution[ResolutionKey.ValueSet] as IEnumerable<Dictionary<string, string>>;
            Assert.AreEqual(Constants.SYS_DATETIME_DATETIME, values.First()[ResolutionKey.Type]);
        }
