...
namespace Microsoft.Recognizers.Text.DateTime.French.Tests
{
    ...
    public class TestTimePeriodExtractor
    {
        ...
        public void TestTimePeriodTimeOfDayExtract()
        {
            ...
            BasicTest("Rendez-vouz dans le matin", 12, 13); // let's meet in the morning
            BasicTest("Rendez-vouz dans l'apres-midi", 12, 17); // let's meet in the afternoon
            BasicTest("Rendez-vouz dans le nuit", 12, 12); // let's meet in the night
            BasicTest("Rendez-vouz dans la soiree", 12, 14); // lets meet in the evening
            BasicTest("Rendez-vouz dans le soirée", 12, 14);
        }
        ...
        {
            // Note: just repeat tests from above
