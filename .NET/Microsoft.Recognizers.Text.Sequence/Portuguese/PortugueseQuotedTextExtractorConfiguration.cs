...
{
    public class PortugueseQuotedTextExtractorConfiguration : QuotedTextConfiguration
    {
        public PortugueseQuotedTextExtractorConfiguration(SequenceOptions options)
     : base(options)
        {
