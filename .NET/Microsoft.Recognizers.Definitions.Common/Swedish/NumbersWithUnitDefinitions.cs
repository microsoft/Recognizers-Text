      ...
      public static readonly Dictionary<string, string> CurrencySuffixList = new Dictionary<string, string>
        {
            ...
            { @"Netherlands guilder", @"netherlands antillean guilder|ang|nederlandse gulden|guilders|guilder|gulden|-guilders|-guilder|dutch guilders|dutch guilder|fl" },
            ...
            { @"Swedish krona", @"swedish krona|sek|swedan krona|spänn" },
