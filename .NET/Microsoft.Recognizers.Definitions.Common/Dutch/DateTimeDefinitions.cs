...
namespace Microsoft.Recognizers.Definitions.Dutch
{
    ...
    public static class DateTimeDefinitions
    {
      ...
      public static readonly string WrittenNumRegex = $@"({WrittenOneToNineRegex}|{WrittenElevenToNineteenRegex}|({WrittenOneToNineRegex}(en|ën))?{WrittenTensRegex})";
      ...
      public static readonly string WhichWeekRegex = $@"\b(week)(\s*)((?<number>5[0-3]|[1-4]\d|0?[1-9])|(?<writtenNumber>{WrittenNumRegex}))(\s+van\s+({YearRegex}|{RelativeRegex}\s+jaar))?\b";
