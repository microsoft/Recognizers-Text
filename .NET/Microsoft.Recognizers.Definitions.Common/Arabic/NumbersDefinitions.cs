...
namespace Microsoft.Recognizers.Definitions.Arabic
{
    ...
    public static class NumbersDefinitions
    {
        ...
        public static readonly string AllOrdinalRegex = $@"(?:{SuffixBasicOrdinalRegex}|(({NumberOrdinalRegex})(\s+و\s+))*(({AllIntRegex})|({NumberOrdinalRegex}))|{SuffixRoundNumberOrdinalRegex})";
