...
namespace Microsoft.Recognizers.Definitions.Arabic
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public static readonly string RoundNumberOrdinalRegex = $@"(?:(((من|على)\s+)|(ب))({RoundNumberIntegerRegex}))";
      ...
      public static readonly string AllOrdinalRegex = $@"(?:{SuffixBasicOrdinalRegex}|{AllIntRegex}|{SuffixRoundNumberOrdinalRegex})";
      ...
      public static readonly string FractionNounWithArticleRegex = $@"(?<=\b)((({AllIntRegex}\s+(و\s+)?)?(an?|one)(\s+|\s*-\s*)(?!\bfirst\b|\bsecond\b)(({AllOrdinalRegex})|({RoundNumberOrdinalRegex})|نصف|ربع))|(نصف))(?=\b)";
