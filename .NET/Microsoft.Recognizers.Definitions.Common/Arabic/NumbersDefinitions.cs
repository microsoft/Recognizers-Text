...
namespace Microsoft.Recognizers.Definitions.Arabic
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public const string RoundNumberIntegerRegex = @"(ال)?(?:مائتان|مائة|مائة|مائتين|ثلاثمائه|أربعة مئة|خمسمائة|ستمائة|سبعمائة|ثمان مائة|تسعمائة|تريليون|ترليون|تريليونين|تريليونات|مليار|ملياري|مليارات|مليون|مليونان|ملايين|ملايين|ألف|مليونين|ألفين|مئة|الآف)";
      public const string ZeroToNineIntegerRegex = @"(وخمسة|وواحد|واحد|وأربعة|واثنان|اثنان|وثلاثة|ثلاثة|واربعة|أربعة|خمسة|وستة|ستة|وسبعة|سبعة|وثمانية|ثمانية|وتسعة|تسع|أحد|اثني|ثلاث|صفر|سبع|ست|اربع|السادس|الثامنة|تسعة|اثنين|واحدُ|وواحدُ:?)";
      ...
      public static readonly Func<string, string> NumbersWithPlaceHolder = (placeholder) => $@"(((?<!{{?[\u0660-\u0669]}}+\s*)-\s*)|(?<=\b))?[\u0660-\u0669]+(?!([\,]?[\u0660-\u0669]))(?={placeholder})";
      public static readonly string NumbersWithSuffix = $@"((((?<!{{?[\u0660-\u0669]}}+\s*)-\s*)|(?<=\b))?[\u0660-\u0669]+(?!([\,]?[\u0660-\u0669])))+\s*{BaseNumbers.NumberMultiplierRegex}(?=\b)";
      public static readonly string RoundNumberIntegerRegexWithLocks = $@"((((?<!{{?[\u0660-\u0669]}}+\s*)-\s*)|(?<=\b))?[\u0660-\u0669]+(?!([\,]?[\u0660-\u0669])))+\s+{RoundNumberIntegerRegex}(?=\b)";
