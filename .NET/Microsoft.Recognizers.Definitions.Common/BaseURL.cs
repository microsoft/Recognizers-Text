...
namespace Microsoft.Recognizers.Definitions
{
	...
	public static class BaseURL
	{
		...
		public const string UnicodeRestrictionRegex = @"(?<=\s|[\'""\(\[:：]|^|[\u0800-\u9FFF])";
		...
		public static readonly string UnicodeUrlPrefixRegex = $@"({UnicodeRestrictionRegex}{ProtocolRegex}?|{ProtocolRegex})[a-zA-Z0-9][-a-zA-Z0-9._]{{0,256}}(?<![.])\.";
		...
		public static readonly string UnicodeUrlRegex = $@"{UnicodeUrlPrefixRegex}(?<Tld>[a-zA-Z]{{2,18}}){UrlSuffixRegex}";
