      ...
      public static readonly Dictionary<string, string> CurrencySuffixList = new Dictionary<string, string>
        {
            ...
            { @"Manat", @"manats|manat" },
            { @"Qəpik", @"qəpik" },
            { @"Somali shilling", @"scellino somalo|scellini somali|scellino della somalia|scellini della somalia|shilin|sh.so.|sos" },
            ...
            { @"Pence", @"pence" },
            { @"Shilling", @"shillings|shilling|shilingi|sh|scellino|scellini" },
            { @"Penny", @"pennies|penny" },
