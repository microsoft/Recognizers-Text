...
namespace Microsoft.Recognizers.Definitions.Spanish
{
    ...
    public static class DateTimeDefinitions
    {
      ...
      public const string HalfTokenRegex = @"\b((y\s+)?media)\b";
      public const string QuarterTokenRegex = @"\b((y\s+)?cuarto|(?<neg>menos\s+cuarto))\b";
      public const string PastTokenRegex = @"\b(pasad[ao]s(\s+(de\s+)?las)?)$";
      public const string ToTokenRegex = @"\b((para|antes)(\s+(de\s+)?las?)|(?<neg>menos))\b";
      ...
      public static readonly string MinuteNumRegex = $@"(({TensTimeRegex}\s*(y)?\s*)?(?<minnum>uno?|d[óo]s|tr[eé]s|cuatro|cinco|s[eé]is|siete|ocho|nueve)|(?<minnum>diez|once|doce|trece|catorce|quince|diecis[eé]is|diecisiete|dieciocho|diecinueve|veinte|treinta|cuarenta|cincuenta))";
      public static readonly string DeltaMinuteNumRegex = $@"(({TensTimeRegex}\s*(y)?\s*)?(?<deltaminnum>uno?|d[óo]s|tr[eé]s|cuatro|cinco|s[eé]is|siete|ocho|nueve)|(?<deltaminnum>diez|once|doce|trece|catorce|quince|diecis[eé]is|diecisiete|dieciocho|diecinueve|veinte|treinta|cuarenta|cincuenta))";
