...
namespace Microsoft.Recognizers.Definitions.Korean
{
    ...
    public static class DateTimeDefinitions
    {
      ...
      public static readonly string YearRegex = $@"(?:(\b(?<![$])(?<year>((1\d|20)\d{{2}})|2100)(?!\.0\b))|{FullTextYearRegex})";
      ...
      public const string HolidayList1 = @"(?<holiday>코퍼스 크리스티|노동절|메이데이|크리스마스|섣달그믐날|모든 성도의 하루|만우절(\s?이브)?|광복절|추석|개천절|한글날|삼일절|(속죄|재의 수요|성회 수요|성지 주|성 목요|마운디 목요|성금요|부활절 토요|부활절 금요|예수 승천|성신 강림 축|삼위 일체의 축|삼위일체의 주|성체축|성체 성혈 대축|워싱턴 탄생|워싱턴 생|현충|식목|식목|독립|프랑스 혁명기념|위령|석가탄신)(\s?일))";
      public const string HolidayList2 = @"(?<holiday>(추수감사절|아버지의 날|새해|클린 먼데이|부활절|크리스마스)(?=에\b)?|(굿 프라이|화이트 먼|트리너티 선|블랙 프라이|사이버 먼|마틴 루터 킹|컬럼버스|콜롬버스|메모리얼|싱글|걸스|화이트|러버|발렌타인|메이|인디펜던스|할로윈|준틴스)(\s?데이))";
      public const string HolidayList3 = @"(?<holiday>(마틴 루터 킹 데이(?=는\b)?|국제 노동자의|지구의|아버지의|어머니의|캔버라의|스승의|젊음의|어린이|여성의|취임|그라운드호그|국제 노동자의|할로윈의|미국 재향군인의 날|섣달그믐|설|한글)(\s?날))";
      public static readonly string HolidayRegex = $@"\b(({StrictRelativeRegex}\s+({HolidayList2}|{HolidayList1}|{HolidayList3}))|((({YearRegex}년?|내년|{RelativeRegex}\s+year)\s+)?({HolidayList2}|{HolidayList1}|{HolidayList3})))";
      ...
      public static readonly Dictionary<string, IEnumerable<string>> HolidayNames = new Dictionary<string, IEnumerable<string>>
        {
            { @"easterday", new string[] { @"부활절" } },
            { @"ashwednesday", new string[] { @"속죄일", @"재의 수요일", @"성회 수요일" } },
            { @"palmsunday", new string[] { @"성지 주일" } },
            { @"maundythursday", new string[] { @"성 목요일", @"마운디 목요일" } },
            { @"goodfriday", new string[] { @"성금요일", @"굿 프라이데이" } },
            { @"eastersaturday", new string[] { @"부활절 토요일" } },
            { @"eastermonday", new string[] { @"부활절 금요일" } },
            { @"ascensionday", new string[] { @"예수 승천 일" } },
            { @"whitesunday", new string[] { @"성신 강림 축일" } },
            { @"whitemonday", new string[] { @"화이트 먼데이" } },
            { @"trinitysunday", new string[] { @"삼위 일체의 축일", @"삼위일체의 주일", @"트리너티 선데이" } },
            { @"corpuschristi", new string[] { @"코퍼스 크리스티", @"성체축일", @"성체 성혈 대축일" } },
            { @"earthday", new string[] { @"지구의 날" } },
            { @"fathers", new string[] { @"아버지의 날" } },
            { @"mothers", new string[] { @"어머니의 날" } },
            { @"thanksgiving", new string[] { @"추수감사절" } },
            { @"blackfriday", new string[] { @"블랙 프라이데이" } },
            { @"cybermonday", new string[] { @"사이버 먼데이" } },
            { @"martinlutherking", new string[] { @"마틴 루터 킹 데이" } },
            { @"washingtonsbirthday", new string[] { @"워싱턴 탄생일", @"워싱턴 생일" } },
            { @"canberra", new string[] { @"캔버라의 날" } },
            { @"labour", new string[] { @"노동절" } },
            { @"columbus", new string[] { @"컬럼버스 데이", @"콜롬버스 데이" } },
            { @"memorial", new string[] { @"현충일", @"메모리얼 데이" } },
            { @"teachersday", new string[] { @"스승의 날" } },
            { @"singleday", new string[] { @"싱글 데이" } },
            { @"allsaintsday", new string[] { @"모든 성도의 하루" } },
            { @"youthday", new string[] { @"젊음의 날" } },
            { @"childrenday", new string[] { @"어린이 날" } },
            { @"femaleday", new string[] { @"여성의 날" } },
            { @"treeplantingday", new string[] { @"식목일" } },
            { @"arborday", new string[] { @"식목일" } },
            { @"girlsday", new string[] { @"걸스데이" } },
            { @"whiteloverday", new string[] { @"화이트데이" } },
            { @"loverday", new string[] { @"러버 데이" } },
            { @"christmas", new string[] { @"크리스마스" } },
            { @"xmas", new string[] { @"크리스마스" } },
            { @"newyear", new string[] { @"새해" } },
            { @"newyearday", new string[] { @"새해" } },
            { @"newyearsday", new string[] { @"새해" } },
            { @"inaugurationday", new string[] { @"취임날" } },
            { @"groundhougday", new string[] { @"그라운드호그 날" } },
            { @"valentinesday", new string[] { @"발렌타인 데이" } },
            { @"aprilfools", new string[] { @"만우절" } },
            { @"mayday", new string[] { @"메이데이", @"국제 노동자의 날" } },
            { @"usindependenceday", new string[] { @"독립일", @"인디펜던스 데이" } },
            { @"independenceday", new string[] { @"독립일", @"인디펜던스 데이" } },
            { @"bastilleday", new string[] { @"프랑스 혁명기념일" } },
            { @"halloweenday", new string[] { @"할로윈 데이", @"할로윈의 날" } },
            { @"allsoulsday", new string[] { @"위령일" } },
            { @"veteransday", new string[] { @"미국 재향군인의 날" } },
            { @"christmaseve", new string[] { @"크리스마스 이브", @"크리스마스이브" } },
            { @"newyeareve", new string[] { @"섣달그믐날" } },
            { @"juneteenth", new string[] { @"준틴스데이" } },
            { @"lunarnewyear", new string[] { @"설날" } },
            { @"independencemovementday", new string[] { @"삼일절" } },
            { @"buddhabirthday", new string[] { @"석가탄신일" } },
            { @"liberationday", new string[] { @"광복절" } },
            { @"chuseok", new string[] { @"추석" } },
            { @"midautumnfestivalday", new string[] { @"추석" } },
            { @"nationalfoundationday", new string[] { @"개천절" } },
            { @"hangeulproclamationday", new string[] { @"한글날" } }
        };
