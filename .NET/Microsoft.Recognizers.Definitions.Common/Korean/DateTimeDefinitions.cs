...
namespace Microsoft.Recognizers.Definitions.Korean
{
    ...
    public static class DateTimeDefinitions
    {
      ...
      public const string ZeroToNineIntegerRegexChs = @"[일이삼사오육륙칠팔구영공]";
      ...
      public const string CenturyRegexInKorean = @"(?<century>一|二|三|四|五|六|七|八|九|十|十一|十二|十三|十四|十五|十六|十七|十八|十九|二十|二十一|二十二)世纪";
      ...
      public const string DecadeRegexInKorean = @"(?<decade>十|一十|二十|三十|四十|五十|六十|七十|八十|九十)";
      public static readonly string DecadeRegex = $@"(?<centurysuf>({CenturyRegex}|{CenturyRegexInKorean}|{RelativeCenturyRegex}))?(?<decade>(\d0|{DecadeRegexInKorean}))年代";
