...
namespace Microsoft.Recognizers.Definitions.Korean
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public const string ZeroToNineIntegerRegex = @"(영|령|공|일|이(?!다)|두|삼|사|오|육|칠|팔|구)";
      ...
      public static readonly string NotSingleRegex = $@"((({ZeroToNineIntegerRegex}|{ZeroToNineFullHalfRegex}|[십])\s*(\s*{RoundNumberIntegerRegex}){{1,2}}(와)?|십|{RoundNumberIntegerRegex}\s*({ZeroToNineIntegerRegex}|{ZeroToNineFullHalfRegex}|영))\s*((({ZeroToNineIntegerRegex}|{ZeroToNineFullHalfRegex})\s*(\s*{RoundNumberIntegerRegex}){{1,2}}(와)?|영)\s*)*{ZeroToNineIntegerRegex}?)";
      public static readonly string SingleRegex = $@"(?<!((연필)|(예산)|(사람들)|(년)|(명)))((?<!{ZeroToNineIntegerRegex})(영|령|공|일|두|삼|사|오|육|칠|팔|구)(?={AllowListRegex}))";
