...
namespace Microsoft.Recognizers.Definitions.English
{
    ...
    public static class NumbersWithUnitDefinitions
    {
      ...
      public static readonly Dictionary<string, IEnumerable<double>> DimensionUnitMultiplesMap = new Dictionary<string, IEnumerable<double>>
        {
            { @"Kilometer", new double[] { 1, 1000 } },
            { @"Hectometer", new double[] { 1, 100 } },
            { @"Decameter", new double[] { 1, 10 } },
            { @"Meter", new double[] { 1, 1 } },
            { @"Decimeter", new double[] { 1, 0.1 } },
            { @"Centimeter", new double[] { 1, 0.01 } },
            { @"Millimeter", new double[] { 1, 0.001 } },
            { @"Micrometer", new double[] { 1, 0.000001 } },
            { @"Nanometer", new double[] { 1, 0.000000001 } },
            { @"Picometer", new double[] { 1, 0.000000000001 } },
            { @"Mile", new double[] { 2, 63360 } },
            { @"Yard", new double[] { 2, 36 } },
            { @"Foot", new double[] { 2, 12 } },
            { @"Inch", new double[] { 2, 1 } },
            { @"Square kilometer", new double[] { 3, 1000000 } },
            { @"Square hectometer", new double[] { 3, 10000 } },
            { @"Square decameter", new double[] { 3, 100 } },
            { @"Square meter", new double[] { 3, 1 } },
            { @"Square decimeter", new double[] { 3, 0.01 } },
            { @"Square centimeter", new double[] { 3, 0.0001 } },
            { @"Square millimeter", new double[] { 3, 0.000001 } },
            { @"Square mile", new double[] { 4, 4014489600 } },
            { @"Acre", new double[] { 4, 6272640 } },
            { @"Square yard", new double[] { 4, 1296 } },
            { @"Square foot", new double[] { 4, 144 } },
            { @"Square inch", new double[] { 4, 1 } },
            { @"Cubic meter", new double[] { 5, 1 } },
            { @"Cubic centimeter", new double[] { 5, 0.000001 } },
            { @"Cubic millimiter", new double[] { 5, 0.000000001 } },
            { @"Hectoliter", new double[] { 6, 100 } },
            { @"Decaliter", new double[] { 6, 10 } },
            { @"Liter", new double[] { 6, 1 } },
            { @"Deciliter", new double[] { 6, 0.1 } },
            { @"Centiliter", new double[] { 6, 0.01 } },
            { @"Milliliter", new double[] { 6, 0.001 } },
            { @"Cubic mile", new double[] { 7, 254358061056000 } },
            { @"Cubic yard", new double[] { 7, 46656 } },
            { @"Cubic foot", new double[] { 7, 1728 } },
            { @"Cubic inch", new double[] { 7, 1 } },
            { @"Pint", new double[] { 8, 96 } },
            { @"Fluid ounce", new double[] { 8, 6 } },
            { @"Tablespoon", new double[] { 8, 3 } },
            { @"Teaspoon", new double[] { 8, 1 } },
            { @"Metric ton", new double[] { 9, 1000000 } },
            { @"Kilogram", new double[] { 9, 1000 } },
            { @"Gram", new double[] { 9, 1 } },
            { @"Milligram", new double[] { 9, 0.001 } },
            { @"Ton", new double[] { 10, 32000 } },
            { @"Gallon", new double[] { 10, 133.44 } },
            { @"Pound", new double[] { 10, 16 } },
            { @"Ounce", new double[] { 10, 1 } },
            { @"Bit", new double[] { 11, 1 } },
            { @"Kilobit", new double[] { 11, 1000 } },
            { @"Megabit", new double[] { 11, 1000000 } },
            { @"Gigabit", new double[] { 11, 1000000000 } },
            { @"Terabit", new double[] { 11, 1000000000000 } },
            { @"Petabit", new double[] { 11, 1000000000000000 } },
            { @"Byte", new double[] { 12, 1 } },
            { @"Kilobyte", new double[] { 12, 1000 } },
            { @"Megabyte", new double[] { 12, 1000000 } },
            { @"Gigabyte", new double[] { 12, 1000000000 } },
            { @"Terabyte", new double[] { 12, 1000000000000 } },
            { @"Petabyte", new double[] { 12, 1000000000000000 } }
        };
    }
}