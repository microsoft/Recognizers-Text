...
namespace Microsoft.Recognizers.Definitions.English
{
    ...
    public static class DateTimeDefinitions
    {
      ...
      public const string TasksModeNextWeekRegex = @"\b(next\s+week)\b";
      public const string TasksModeNextMonthRegex = @"\b(next\s+month)\b";
      public const string TasksModeNextYearRegex = @"\b(next\s+year)\b";
      public static readonly string TasksModeDurationToDate = $@"({TasksModeNextWeekRegex}|{TasksModeNextMonthRegex}|{TasksModeNextYearRegex})";
