...
namespace Microsoft.Recognizers.Definitions.English
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public static readonly string OneNumberRangeMoreRegex1 = $@"(?<!no\s{{1,10}})({MoreOrEqual}|{MoreRegex})\s*(the\s+)?(?<number1>({NumberSplitMark}.)+)";
      ...
      public static readonly string OneNumberRangeLessRegex1 = $@"(?<!no\s{{1,10}})({LessOrEqual}|{LessRegex})\s*(the\s+)?(?<number2>({NumberSplitMark}.)+)";
