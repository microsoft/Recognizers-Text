...
namespace Microsoft.Recognizers.Definitions.English
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public const string RelativeOrdinalRegex = @"((next|previous|current) one|(the second|next) to last|the one before the last( one)?|the last but one|(ante)?penultimate|last|next|previous|current)";
      ...
      public const string MoreRegex = @"((bigger|greater|more|higher|larger)(\s+than)?|above|over|exceed|surpass|(?<!<|=)>)";
