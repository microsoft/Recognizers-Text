...
namespace Microsoft.Recognizers.Definitions.Chinese
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public static readonly string NumbersWithDozen = $@"{AllIntRegex}[对對打](?!{AllIntRegex})";
