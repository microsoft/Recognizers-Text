...
namespace Microsoft.Recognizers.Definitions.Chinese
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public const string RoundNumberIntegerRegex = @"(((?<![十百千拾佰仟])[十百千拾佰仟])|([万亿兆萬億]{1,2}))";
      ...
      public static readonly string NotSingleRegex = $@"((({DigitNumPlusRegex}|[十拾])\s*(\s*[多几幾余]?\s*{RoundNumberIntegerRegex}){{1,2}}|[十拾]|{RoundNumberIntegerRegex}\s*{ZeroToNineIntegerRegex})\s*|{ZeroToNineFullHalfRegex})(((({DigitNumPlusRegex})\s*(\s*[多几幾余]?\s*{RoundNumberIntegerRegex}){{1,2}}|零)\s*)|({ZeroToNineFullHalfRegex}))*({DigitNumPlusRegex})?";
      public static readonly string SingleRegex = $@"(?<!{ZeroToNineIntegerRegex}){ZeroToNineIntegerRegex}(?={AllowListRegex})";
      public static readonly string AllIntRegex = $@"(((({DigitNumPlusRegex}|[十拾])\s*(\s*[多几幾余]?\s*{RoundNumberIntegerRegex}){{1,2}}|[十拾]|{RoundNumberIntegerRegex}\s*{ZeroToNineIntegerRegex})\s*|{ZeroToNineFullHalfRegex})(((({DigitNumPlusRegex})\s*(\s*[多几幾余]?\s*{RoundNumberIntegerRegex}){{1,2}}|零)\s*)|({ZeroToNineFullHalfRegex}))*({DigitNumPlusRegex})?|({DigitNumPlusRegex}))";
