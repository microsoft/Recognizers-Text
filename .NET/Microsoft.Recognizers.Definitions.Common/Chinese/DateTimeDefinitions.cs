...
namespace Microsoft.Recognizers.Definitions.Chinese
{
    ...
    public static class DateTimeDefinitions
    {
      ...
      public const string MonthDayRange = @"^[.]";
      ...
      public const string DatePeriodNextRegex = @"下下|下个|下一个|下|下一";
      ...
      public const string WhichWeekRegex = @"^[.]";
      ...
      public const string CenturyNumRegex = @"^[.]";
