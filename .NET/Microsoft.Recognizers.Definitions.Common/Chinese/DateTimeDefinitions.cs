...
namespace Microsoft.Recognizers.Definitions.Chinese
{
    ...
    public static class DateTimeDefinitions
    {
      ...
      public static readonly string DateDayRegexInChinese = $@"(?<day>(([12][0-9]|3[01]|[1-9]|[三叁][十拾][一壹]?|[二贰貳]?[十拾]({OneToNineIntegerRegex})?|{OneToNineIntegerRegex})[日号]|初一|三十))";
      public static readonly string DayRegexNumInChinese = $@"(?<day>[12][0-9]|3[01]|[1-9]|[三叁][十拾][一壹]?|[二贰貳]?[十拾]({OneToNineIntegerRegex})?|{OneToNineIntegerRegex}|廿|卅)";
