...
namespace Microsoft.Recognizers.Definitions.Chinese
{
    ...
    public static class DateTimeDefinitions
    {
      ...
      public static readonly string TimePeriodLeftChsTimeRegex = $@"(从)?(?<left>{TimeDayDescRegex}?({TimeCJKTimeRegex}))";
      public static readonly string TimePeriodRightChsTimeRegex = $@"{TimePeriodTimePeriodConnectWords}(?<right>{TimeDayDescRegex}?{TimeCJKTimeRegex})(之间)?";
