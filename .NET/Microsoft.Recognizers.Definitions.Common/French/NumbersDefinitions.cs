...
namespace Microsoft.Recognizers.Definitions.French
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public const string OneToNineOrdinalRegex = @"(premi[eè]re|premier|deuxi[eè]me|second[e]|troisi[eè]me|tiers|tierce|quatri[eè]me|cinqui[eè]me|sixi[eè]me|septi[eè]me|huiti[eè]me|neuvi[eè]me)";
      ...
      public static readonly string FractionNounWithArticleRegex = $@"(?<=\b)({AllIntRegex}\s+(et\s+)?)?(une?)(\s+)(({AllOrdinalRegex})|({SuffixOrdinalRegex})|(et\s+)?demis?)(?=\b)";
