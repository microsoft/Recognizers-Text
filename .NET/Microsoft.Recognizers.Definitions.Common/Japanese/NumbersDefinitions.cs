...
namespace Microsoft.Recognizers.Definitions.Japanese
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public static readonly string DoubleExponentialNotationRegex1 = $@"(?<!{ZeroToNineFullHalfRegex}+[\.．])(({NegativeNumberTermsRegexNum}|{NegativeNumberTermsRegex})\s*)?{ZeroToNineFullHalfRegex}+([\.．]{ZeroToNineFullHalfRegex}+)?(×)?(10)?(e|の)(([-－+＋]*[1-9１２３４５６７８９]{ZeroToNineFullHalfRegex}*)[乗]|[0０](?!{ZeroToNineFullHalfRegex}+))";
