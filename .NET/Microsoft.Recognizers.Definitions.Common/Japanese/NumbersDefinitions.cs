...
namespace Microsoft.Recognizers.Definitions.Japanese
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public static readonly string AllIntRegex = $@"(((({ZeroToNineIntegerRegex}|[十百千])\s*{RoundNumberIntegerRegex}*)|({ZeroToNineFullHalfRegex}|{RoundNumberIntegerRegex})\s*){{1,2}}(\s*[以上])?)";
      ...
      public static readonly string NumbersWithDozen = $@"{AllIntRegex}(ダース)([十百千万億兆])?(?!{AllIntRegex})";
