...
namespace Microsoft.Recognizers.Definitions.Japanese
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public const string ZeroToNineIntegerRegex = @"(?:〇|一|二|三|四|五|六|七|八|九)";
      public const string NegativeNumberTermsRegex = @"(マ\s*イ\s*ナ\s*ス)";
      public const string NegativeNumberTermsRegexNum = @"(?<negTerm>(-|−|－)\s*)";
      ...
      public static readonly string NotSingleRegex = $@"(?<!(第|だい))(({RoundNumberIntegerRegex}+(({ZeroToNineIntegerRegex}|[十百千万億兆])+|{ZeroToNineFullHalfRegex}+|十)\s*))|(({ZeroToNineIntegerRegex}+|{ZeroToNineFullHalfRegex}+|十)({RoundNumberIntegerRegex}){{1,2}})(([零]?({ZeroToNineIntegerRegex}+|{ZeroToNineFullHalfRegex}+|十){RoundNumberIntegerRegex}{{0,1}}))*((以上)?)";
      public static readonly string SingleRegex = $@"(({ZeroToNineIntegerRegex}+|{ZeroToNineFullHalfRegex}+|十)(?={AllowListRegex})?)";
      public static readonly string AllIntRegex = $@"(((({ZeroToNineIntegerRegex}|[十百千])\s*(と)?{RoundNumberIntegerRegex}*)(と)?|({ZeroToNineFullHalfRegex}+(と)?|{RoundNumberIntegerRegex})\s*){{1,2}}(\s*[以上])?)";
      public const string PlaceHolderPureNumber = @"\b";
      public const string PlaceHolderDefault = @"\D|\b";
      public static readonly string NumbersSpecialsChars = $@"({NegativeNumberTermsRegexNum}|{NegativeNumberTermsRegex})\s*({AllIntRegex}\s*)";
      ...
      public static readonly string NumbersWithDozen = $@"{AllIntRegex}\s*(ダース)\s*";
