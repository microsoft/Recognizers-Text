...
namespace Microsoft.Recognizers.Definitions.Japanese
{
    ...
    public static class DateTimeDefinitions
    {
      ...
      public const string ZeroToNineIntegerRegexCJK = @"[一二三四五六七八九十零壹贰叁肆伍陆柒捌玖〇两千俩倆仨０１２３４５６７８９]";
      ...
      public const string SpecialDayWithNumRegex = @"((いっ)?さくじつ|おとつい|最近|前天|后天|昨天|明天|今天|今日?|明日|一?昨?昨日|一昨日|大后天|大前天|後天|大後天|きょう|あす|あした|きのう|明々後日|(弥)?明後日|この日|前日|二日前|おととい|し?あさって|私の一日|この間|次の日|その日)(から|の)?([\d１２３４５６７８９十一二三四五六七八九]*|数)(日|月|週|個)間?(先|後|前|以内)?(の(?<weekday>日曜日?|月曜日?|火曜日?|水曜日?|木曜日?|金曜日?|土曜日?))?";
      public static readonly string WeekDayOfMonthRegex = $@"((({SpecialMonthRegex}|{MonthRegex}|{MonthNumRegex}|((这个|这一个|这|这一|本|今|上个|上一个|上|上一|去|下个|下一个|下|下一|明)月))(的|の)\s*)?(第|最)?(?<cardinal>([初一二三四五])|([12345１２３４５])|最后一)(个|の|\s)*{WeekDayRegex})";
