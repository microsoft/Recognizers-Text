...
namespace Microsoft.Recognizers.Definitions.Turkish
{
    ...
    public static class NumbersDefinitions
    {
      ...
      public const string RelativeOrdinalRegex = @"(?<relativeOrdinal>(bir\s+)?(sonraki|önceki)|sondan\s+birinci|sondan\s+bir\s+önceki|sondan\s+ikinci|(en\s+)?son|[iİ]lki?|son(uncu(su)?)?|şimdiki)";
