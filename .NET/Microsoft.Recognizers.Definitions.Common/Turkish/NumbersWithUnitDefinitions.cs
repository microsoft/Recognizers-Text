      ...
      public static readonly Dictionary<string, string> CurrencySuffixList = new Dictionary<string, string>
        {
            ...
            { @"Aruban florin", @"aruba florini|aruba ƒ|awg|florin" },
            ...
            { @"Kenyan shilling", @"kenya şilini|kenya sh|kes" },
            ...
            { @"Netherlands guilder", @"hollanda antilleri|hollanda guldeni|ang|gulden|hollanda ƒ|fl|nlg|hollanda florini" },
            ...
            { @"Ugandan shilling", @"uganda şilini|uganda sh|ugx" },
            ...
            { @"Maldivian rufiyaa", @"maldiv rufiyaası|mvr|.ރ" },
            ...
            { @"Peso", @"peso" },
            { @"Centavo", @"centavo" },
            { @"British pound", @"ingiliz sterlini|ingiliz £|gbp|ingiliz poundu" },
            { @"Guernsey pound", @"guernsey sterlini|ggp|guernsey poundu|guernsey £" },
            { @"Saint Helena pound", @"saint helena sterlini|saint helena £|shp|saint helena poundu" },
            { @"Egyptian pound", @"mısır lirası|egp|ج.م" },
            { @"Falkland Islands pound", @"falkland adaları sterlini|falkland adaları £|fkp|falkland adaları poundu" },
            { @"Gibraltar pound", @"gibraltar sterlini|gibraltar £|gip|gibraltar poundu" },
            { @"Manx pound", @"manx sterlini|manx £|imp|manx poundu" },
            { @"Jersey pound", @"jersey sterlini|jersey £|jep|jersey poundu" },
            ...
            { @"Canadian dollar", @"kanada doları|cad|$ c|c$" },
            ...
            { @"Hong Kong dollar", @"hong kong doları|hkd|hk$|hk $" },
            ...
            { @"Fen", @"fen" },
            { @"Jiao", @"jiao|mao" },
            { @"Finnish markka", @"fin markkası|fim|markka|fin markı" },
            { @"Penni", @"penni" }
        };
