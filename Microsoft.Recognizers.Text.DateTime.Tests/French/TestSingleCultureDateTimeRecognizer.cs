...
namespace Microsoft.Recognizers.Text.DateTime.French.Tests
{
    ...
    public class TestSingleCultureDateTimeRecognizer
    {
        ...
        private readonly IModel model = DateTimeRecognizer.GetSingleCultureInstance(Culture.French).GetDateTimeModel();
        ...
        {
            // TODO: Add French (fr-fr) culture to timex, 
            // namespace Microsoft.Recognizers.Text.DateTime, DateTimeRecognizer.cs 

            // BasicTest("J'irai mentainant", "maintenant");
        }
