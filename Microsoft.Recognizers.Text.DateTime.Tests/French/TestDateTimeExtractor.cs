...
namespace Microsoft.Recognizers.Text.DateTime.French.Tests
{
    ...
    public class TestDateTimeExtractor
    {
        ...
        public void TestDateTimeExtract()
        {
            ...
            //BasicTest("Je reviendrai Oct 23 a sept", 14, 13);
            ...
            //BasicTest("Je vais demain vers 8:00am", 8, 18); // simpletimeoftodaybeforeregex
            ...
            //BasicTest("Je reviendrai une quart a sept landemain", 14, 26);
            BasicTest("Je reviendrai 19:00, 2016-12-22", 14, 17);
            //BasicTest("Je reviendrai sept heures landemain", 14, 21);
            ...
            BasicTest("Je reviendrai en 5 heures", 14, 11); //dateregexlist --> IEnumerable<Regex> IDateExtractorConfiguration.DateRegexList => DateRegexList
        }
    }
}