...
class SpanishNumeric:
    ...
    RoundNumberIntegerRegex = '(mil millones|mil|millones|mill[oó]n|billones|bill[oó]n|trillones|trill[oó]n|cuatrillones|cuatrill[oó]n|quintillones|quintill[oó]n|sextillones|sextill[oó]n|septillones|septill[oó]n)'
    ...
    TwentiesIntegerRegex = '(veinticuatro|veinticinco|veintisiete|veintinueve|veintitr[eé]s|veintis[eé]is|veintiocho|veintid[oó]s|ventiun[ao]|veinti[uú]n[oa]?|veinte)'
    TensNumberIntegerRegex = '(cincuenta|cuarenta|treinta|sesenta|setenta|ochenta|noventa)'
    ...
    NumbersWithDozenSuffix = '(((?<=\\W|^)-\\s*)|(?<=\\b))\\d+\\s+docenas?(?=\\b)'
    ...
    SpecialUnderHundredOrdinalRegex = '(und[eé]cim[oa]|duod[eé]cimo|decimoctav[oa])'
    ...
    OrdinalSuffixRegex = '(?<=\\b)(\\d*(1r[oa]|2d[oa]|3r[oa]|4t[oa]|5t[oa]|6t[oa]|7m[oa]|8v[oa]|9n[oa]|0m[oa]|11[vm][oa]|12[vm][oa]))(?=\\b)'
