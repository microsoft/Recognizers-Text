...
class FrenchNumeric:
    LangMarker = 'Fr'
    RoundNumberIntegerRegex = '(cent|mille|millions|million|milliard|milliards|billion|billions)'
    ZeroToNineIntegerRegex = '(et un|un|une|deux|trois|quatre|cinq|six|sept|huit|neuf)'
    TenToNineteenIntegerRegex = '(dix\\Wneuf|dix\\Whuit|dix\\Wsept|seize|quinze|quatorze|treize|douze|onze|dix)'
    TensNumberIntegerRegex = '(octante|vingt|trente|quarante|cinquante|soixante-dix|soixante|septante|huitante|quatre-vingt-dix|nonante)'
    ...
    NumbersWithSuffix = '(((?<=\\W|^)-\\s*)|(?<=\\b))\\d+\\s*(k|M|T|G)(?=\\b)'
    ...
    SimpleRoundOrdinalRegex = '(centi[eè]me|milli[eè]me|millioni[eè]me|milliardi[eè]me|billioni[eè]me)'
    OneToNineOrdinalRegex = '(premier|premi[eè]re|deuxi[eè]me|second[e]|troisi[eè]me|tiers|tierce|quatri[eè]me|cinqui[eè]me|sixi[eè]me|septi[eè]me|huiti[eè]me|neuvi[eè]me)'
    SpecialUnderHundredOrdinalRegex = '(onzi[eè]me|douzi[eè]me)'
    TensOrdinalRegex = '(quatre-vingt-dixi[eè]me|quatre-vingti[eè]me|huitanti[eè]me|octanti[eè]me|soixante-dixi[eè]me|septanti[eè]me|soixanti[eè]me|cinquanti[eè]me|quaranti[eè]me|trenti[eè]me|vingti[eè]me)'
    ...
    OrdinalSuffixRegex = '(?<=\\b)((\\d*(1er|2e|2eme|3e|3eme|4e|4eme|5e|5eme|6e|6eme|7e|7eme|8e|8eme|9e|9eme|0e|0eme))|(11e|11eme|12e|12eme))(?=\\b)'
    ...
    DoubleWithMultiplierRegex = '(((?<!\\d+\\s*)-\\s*)|((?<=\\b)(?<!\\d+\\,)))\\d+,\\d+\\s*(K|k|M|G|T)(?=\\b)'
    ...
    CurrencyRegex = '(((?<=\\W|^)-\\s*)|(?<=\\b))\\d+\\s*(B|b|m|t|g)(?=\\b)'
    NumberWithSuffixPercentage = f'({BaseNumbers.NumberReplaceToken})(\\s*)(%|pourcentages|pourcents|pourcentage|pourcent)'
    NumberWithPrefixPercentage = f'(%|pourcent|pourcent des|pourcentage de)(\\s*)({BaseNumbers.NumberReplaceToken})'
