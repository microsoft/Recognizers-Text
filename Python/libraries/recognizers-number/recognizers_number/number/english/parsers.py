...
class EnglishNumberParserConfiguration(NumberParserConfiguration):
    ...
    def __init__(self, culture_info=None):
        ...
        self._negative_number_sign_regex = regex.compile(EnglishNumeric.NegativeNumberSignRegex)
        self._half_a_dozen_regex = regex.compile(EnglishNumeric.HalfADozenRegex)
