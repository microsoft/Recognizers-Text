...
class FrenchNumberParserConfiguration(NumberParserConfiguration):
    ...
    def __init__(self, culture_info=None):
        ...
        self._negative_number_sign_regex = regex.compile(FrenchNumeric.NegativeNumberSignRegex)
        self._half_a_dozen_regex = regex.compile(FrenchNumeric.HalfADozenRegex)
        self._digital_number_regex = regex.compile(FrenchNumeric.DigitalNumberRegex)
