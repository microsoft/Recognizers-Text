...
class Recognizer(Generic[TModelOptions], ABC):
    def __init__(self, target_culture: str, options: TModelOptions, lazyInitialization: bool):
    ...
    def register_model(self, model_type_name: str, culture: str, modelCtor: Callable[[TModelOptions], Model]):
        raise NotImplementedError