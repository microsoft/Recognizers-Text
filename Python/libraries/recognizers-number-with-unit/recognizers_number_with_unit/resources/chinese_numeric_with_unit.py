...
class ChineseNumericWithUnit:
    ...
    CurrencyPrefixList = dict([('Dollar', '$'),
                               ...
                               ('Pound', '£'),
                               ('Costa Rican colón', '₡')])
    CurrencyAmbiguousValues = ['元', '仙', '分', '圆', '块', '毛', '盾', '箍', '蚊', '角']
    DimensionSuffixList = dict([('Meter', '米|公尺'),
                                ('Kilometer', '千米|公里'),
                                ('Decimeter', '分米|公寸'),
                                ('Centimeter', '釐米|厘米|公分'),
                                ('Micrometer', '毫米|公釐'),
                                ...
                                ('Terabyte', '万亿字节|兆兆字节'),
                                ('Petabyte', '千兆兆|千万亿字节')])
    DimensionAmbiguousValues = ['丈', '位', '克', '分', '升', '寸', '尺', '斗', '斤', '桶', '毫', '石', '码', '磅', '米', '罐', '里']
    TemperatureSuffixList = dict([('F', '华氏温度|华氏度'),
                                  ('K', 'k|开尔文温度|开氏度|凯氏度'),
                                  ('R', '兰氏温度'),
                                  ('C', '摄氏温度|摄氏度'),
                                  ('Degree', '度')])
