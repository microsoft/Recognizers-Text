...
class DutchNumericWithUnit:
    ...
    SpeedSuffixList = dict([
        ("Meter per second",
         "meters / seconde|m/s|m per seconde|meters per seconde|meters per secondes|meter per seconde|meter per secondes"),
    ...
    AmbiguousVolumeUnitList = ["l", "ons", "oz", "cup", "peck", "cord", "gill"]

    WeightSuffixList = dict([
    ...
    AmbiguousWeightUnitList = ["g", "t", "oz"]
    ...
    AmbiguousCurrencyUnitList = [
        "din.', r'kiwi', r'kina', r'kobo', r'lari', r'lipa', r'napa', r'para', r'sfr.', r'taka', r'tala', r'toea', r'vatu', r'yuan', r'ang', r'ban', r'bob',  r'btn', r'byr', r'cad', r'cop', r'cup', r'dop', r'gip', r'jod', r'kgs', r'lak', r'lei', r'mga', r'mop', r'nad', r'omr', r'pul', r'sar', r'sbd', r'scr', r'sdg', r'sek', r'sen', r'sol', r'sos', r'std', r'try', r'yer', r'yen"]

    AngleSuffixList = dict([
        ("Degree", "graad|graden|°"),
        ("Radian", "radiaal|radialen|rad"),
        ("Turn", "draai|draaien|slag|slagen")])

    AmbiguousAngleUnitList = ["draai", "draaien", "slag", "slagen"]

    AmbiguityFiltersDict = dict([("null", "null")])

    TemperatureAmbiguityFiltersDict = dict([("\b(gra(ad|den)|°)$",
                                             "\b((gra(ad|den)|°)\s*(draai(en|t)?|geroteerd|roterend|rotatie|hoek)|(draai(en|t)?|geroteerd|roterend|rotatie|hoek)(\s+(\p{L}+|\d+)){0,4}\s*(gra(ad|den)\b|°))")])

    DimensionAmbiguityFiltersDict = dict([("\b(gra(ad|den)|°)$",
                                           "\b((gra(ad|den)|°)\s*(c(elsius)?|f(ah?renheit)?)|(temperatuur)(\s+(\p{L}+|\d+)){0,4}\s*(gra(ad|den)\b|°))")])
