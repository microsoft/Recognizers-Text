...
class SpanishNumericWithUnit:
    ...
    AreaSuffixList = dict([('Kilómetro cuadrado', 'kilómetro cuadrado|kilómetros cuadrados|km2|km^2|km²'),
                           ...
                           ('Acre', 'acre|acres')])
    AreaAmbiguousValues = ['área', 'áreas']
    ...
    DimensionSuffixList = dict([('Kilómetro', 'km|kilometro|kilómetro|kilometros|kilómetros'),
    ...
    AmbiguousDimensionUnitList = ['al', 'mi', 'área', 'áreas', 'pie', 'pies']
    LengthSuffixList = dict([('Kilómetro', 'km|kilometro|kilómetro|kilometros|kilómetros'),
                             ...
                             ('Pie', 'pie|pies|ft'),
                             ('Año luz', 'año luz|años luz|al')])
    AmbiguousLengthUnitList = ['mi', 'área', 'áreas']
    BuildPrefix = f'(?<=(\\s|^|\\P{{L}}))'
    BuildSuffix = f'(?=(\\s|\\P{{L}}|$))'
    ConnectorToken = 'de'
