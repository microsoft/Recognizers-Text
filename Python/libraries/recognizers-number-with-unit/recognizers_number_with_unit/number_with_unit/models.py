        ...
        try:
            for item in self.extractor_parser:
                ...
                for parse_result in parse_results:
                    ...
                    b_add = not [x for x in extraction_results if (x.start == model_result.start and x.end == model_result.end) or (model_result.start <= x.start and model_result.end >= x.end)]
