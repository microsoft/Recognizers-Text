...
REQUIRES = [
    ...
    'recognizers-text-number-with-unit-genesys==1.0.29',
    'recognizers-text-date-time-genesys==1.0.29',
    'recognizers-text-sequence-genesys==1.0.29',
    'recognizers-text-choice-genesys==1.0.29'
]
