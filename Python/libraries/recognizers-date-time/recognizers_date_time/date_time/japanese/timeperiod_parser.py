...
from .timeperiod_parser_config import JapaneseTimePeriodParserConfiguration


class JapaneseTimePeriodParser(BaseTimePeriodParser):
    def __init__(self):
        super().__init__(JapaneseTimePeriodParserConfiguration())
        self.day_description_regex = RegExpUtility.get_safe_reg_exp(
            JapaneseDateTime.TimeDayDescRegex)
    ...
    def parse(self, source: ExtractResult, reference: datetime = None) -> Optional[DateTimeParseResult]:
        ...
        if source.type is self.parser_type_name:
            inner_result = self.parse_japanese_time_of_day(
    ...
    def parse_japanese_time_of_day(self, text: str, reference: datetime) -> DateTimeResolutionResult:
