...
class ModAndDateResult:
    ...
    def mod_and_date_result(self, begin_date: datetime, end_date: datetime, mod: str = '', date_list: [datetime] = None):
    ...
    @staticmethod
    def get_mod_and_date(begin_date: datetime, end_date: datetime, reference: datetime, timex: str, future: bool):
        ...
        if future:
            ...
            if is_business_day:
                ...
                end_date_result = DurationParsingUtil.get_nth_business_day(begin_date_result, business_day_count-1, future)
            ...
            if is_business_day:
                begin_date_result = DurationParsingUtil.get_nth_business_day(end_date_result, business_day_count-1, future)
