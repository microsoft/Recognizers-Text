...
class ChineseDateTime:
    ...
    DatePeriodTillDependenceRegex = f'(?<till>与|和)'
    ...
    YearToYearDependence = f'((从|在|自)\\s*)?({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\\s*({DatePeriodTillDependenceRegex})\\s*({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\\s*(之间|之内|期间|中间|间)'
    MonthToMonth = f'({MonthRegex}){DatePeriodTillRegex}({MonthRegex})'
    MonthToMonthDependence = f'({MonthRegex}){DatePeriodTillDependenceRegex}({MonthRegex})\\s*(之间|之内|期间|中间|间)'
