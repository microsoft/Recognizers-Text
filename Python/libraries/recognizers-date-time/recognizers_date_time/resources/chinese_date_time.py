...
class ChineseDateTime:
    ...
    YearToYearSuffixRequiredRegex = f'((从|在|自)\\s*)?({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\\s*({DatePeriodTillSuffixRequiredRegex})\\s*({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\\s*(之间|之内|期间|中间|间)'
    MonthToMonth = f'({MonthRegex}){DatePeriodTillRegex}({MonthRegex})'
    MonthToMonthSuffixRequiredRegex = f'({MonthRegex}){DatePeriodTillSuffixRequiredRegex}({MonthRegex})\\s*(之间|之内|期间|中间|间)'
