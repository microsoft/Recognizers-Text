...
class ChineseDateTime:
    ...
    DatePeriodTillSuffixRequired = f'(?<till>与|和)'
    ...
    YearToYearSuffixRequired = f'((从|在|自)\\s*)?({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\\s*({DatePeriodTillSuffixRequired})\\s*({DatePeriodYearInChineseRegex}|{DatePeriodYearRegex})\\s*(之间|之内|期间|中间|间)'
    MonthToMonth = f'({MonthRegex}){DatePeriodTillRegex}({MonthRegex})'
    MonthToMonthSuffixRequired = f'({MonthRegex}){DatePeriodTillSuffixRequired}({MonthRegex})\\s*(之间|之内|期间|中间|间)'
