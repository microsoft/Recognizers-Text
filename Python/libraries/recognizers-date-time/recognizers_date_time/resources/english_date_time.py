...
class EnglishDateTime:
    ...
    DateExtractor6 = f'(?<={DatePreposition}\\s+)({StrictRelativeRegex}\\s+)?({WeekDayRegex}\\s+)?{MonthNumRegex}[\\-\\.]{DayRegex}(?![%]|\\.\\d)\\b'
    DateExtractor7L = f'\\b({WeekDayRegex}\\s+)?(?<!\\.){MonthNumRegex}\\s*/\\s*{DayRegex}{DateExtractorYearTermRegex}(?![%]|\\.\\d)\\b'
    DateExtractor7S = f'\\b({WeekDayRegex}\\s+)?(?<!\\.){MonthNumRegex}\\s*/\\s*{DayRegex}(?![%]|\\.\\d)\\b'
    DateExtractor8 = f'(?<={DatePreposition}\\s+)({StrictRelativeRegex}\\s+)?({WeekDayRegex}\\s+)?{DayRegex}[\\\\\\-]{MonthNumRegex}(?![%]|\\.\\d)\\b'
    DateExtractor9L = f'\\b({WeekDayRegex}\\s+)?(?<!\\.){DayRegex}\\s*/\\s*{MonthNumRegex}{DateExtractorYearTermRegex}(?![%]|\\.\\d)\\b'
    DateExtractor9S = f'\\b({WeekDayRegex}\\s+)?(?<!\\.){DayRegex}\\s*/\\s*{MonthNumRegex}(?![%]|\\.\\d)\\b'
