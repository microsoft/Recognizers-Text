...
class EnglishDateTime:
    ...
    DateYearRegex = f'(?<year>((1\\d|20)\\d{{2}})|2100|(([0-27-9]\\d)\\b(?!(\\s*((\\:)|{AmDescRegex}|{PmDescRegex}|\\.\\d)))))'
    ...
    DateExtractor6 = f'(?<=\\b(on|in)\\s+)({WeekDayRegex}\\s+)?{MonthNumRegex}[\\-\\.]{DayRegex}(?![%])\\b'
    DateExtractor7 = f'\\b({WeekDayRegex}\\s+)?{MonthNumRegex}\\s*/\\s*{DayRegex}((\\s+|\\s*,\\s*|\\s+of\\s+){DateYearRegex})?(?![%])\\b'
    DateExtractor8 = f'(?<=\\b(on|in)\\s+)({WeekDayRegex}\\s+)?{DayRegex}[\\\\\\-]{MonthNumRegex}(?![%])\\b'
    ...
    TimeRegex11 = f'\\bat\\s+{TimeRegexWithDotConnector}'
    TimeRegex12 = f'\\b{TimeRegexWithDotConnector}(\\s*{DescRegex})'
    ...
    SpecificTimeFromTo = f'((from|between)\\s+)?(?<time1>(({TimeRegex2}|{TimeRegexWithDotConnector}(\\s*{DescRegex})?)|({HourRegex}|{PeriodHourNumRegex})(\\s*(?<leftDesc>{DescRegex}))?))\\s*{TillRegex}\\s*(?<time2>(({TimeRegex2}|{TimeRegexWithDotConnector}(?<rightDesc>\\s*{DescRegex}))|({HourRegex}|{PeriodHourNumRegex})(\\s*(?<rightDesc>{DescRegex}))?))'
    SpecificTimeBetweenAnd = f'(between\\s+)(?<time1>(({TimeRegex2}|{TimeRegexWithDotConnector}(\\s*{DescRegex})?)|({HourRegex}|{PeriodHourNumRegex})(\\s*(?<leftDesc>{DescRegex}))?))\\s*{RangeConnectorRegex}\\s*(?<time2>(({TimeRegex2}|{TimeRegexWithDotConnector}(?<rightDesc>\\s*{DescRegex}))|({HourRegex}|{PeriodHourNumRegex})(\\s*(?<rightDesc>{DescRegex}))?))'
