...
public class JapaneseNumericWithUnit {
    ...
    public static final ImmutableMap<String, String> CurrencySuffixList = ImmutableMap.<String, String>builder()
        ...
        .put("Netherlands guilder", "オランダ・ユーロ")
        .put("Surinam florin", "スリナムフロリン")
        ...
        .put("Krone", "クローナ")
        .put("Øre", "オーレ")
        .put("West African CFA franc", "西アフリカCFAフラン")
        .put("Central African CFA franc", "中央アフリカCFAフラン")
        ...
        .put("Cook Islands dollar", "クックアイランド・ドル")
    ...
    public static final ImmutableMap<String, String> DimensionSuffixList = ImmutableMap.<String, String>builder()
        .put("Meter", "米|公尺|m|メートル")
        .put("Kilometer", "千米|公里|km|キロメートル")
        .put("Decimeter", "分米|公寸|dm|デシメートル")
        .put("Millimeter", "ミリ")
        .put("Centimeter", "釐米|厘米|公分|cm|センチ")
        .put("Micrometer", "毫米|公釐|mm")
        .put("Microns", "微米")
        .put("Picometer", "皮米|ピクトメーター|pm")
        .put("Nanometer", "纳米")
        .put("Mile", "英里|マイル")
        .put("Inch", "英寸|インチ")
        .put("Foot", "呎|英尺|フィート")
        ...
        .put("Knot", "海里")
        .put("Light year", "光年")
        .put("Meter per second", "米每秒|米/秒|m/s|秒速メートル|毎秒メートル")
        .put("Kilometer per hour", "公里每小时|千米每小时|公里/小时|千米/小时|km/h|時速キロメートル")
        .put("Kilometer per minute", "公里每分钟|千米每分钟|公里/分钟|千米/分钟|km/min|分速キロメートル")
        .put("Kilometer per second", "公里每秒|千米每秒|公里/秒|千米/秒|km/s|秒速キロメートル|毎秒キロメートル")
        .put("Mile per hour", "英里每小时|英里/小时|時速マイル")
        ...
        .put("Square meter", "平方米|平方メートル")
        .put("Square kilometer", "平方公里|平方キロメートル")
        .put("Acre", "英亩|公亩|エーカー")
        .put("Hectare", "公顷")
        .put("Mu", "亩|市亩|ムー")
        .put("Liter", "公升|升|l")
        .put("Milliliter", "毫升|ml|ミリリットル")
        .put("Cubic meter", "立方米")
        .put("Cubic decimeter", "立方分米")
        .put("Cubic millimeter", "立方毫米")
        .put("Cubic foot", "立方英尺|立方フィート")
        .put("Gallon", "加仑|ガロン")
        .put("Pint", "品脱")
        .put("Dou", "市斗|斗")
        .put("Dan", "市石|石")
        .put("Kilogram", "千克|公斤|kg|キログラム")
        .put("Gram", "克|g")
        .put("Milligram", "毫克|mg")
        .put("Microgram", "微克|μg")
        .put("Ton", "公吨|吨|t|トン")
        .put("Metric ton", "メートルトン")
        .put("Pound", "磅|ポンド")
        .put("Ounce", "盎司|オンス")
        .put("Jin", "市斤|斤")
        .put("Liang", "两")
        .put("Barrel", "桶")
        .put("Pot", "罐")
        .put("Bit", "比特|位|b|bit|ビット")
        .put("Kilobit", "千比特|千位|kb|Kb")
        .put("Megabit", "兆比特|兆位|mb|Mb|メガバイト")
    ...
    public static final ImmutableMap<String, String> DimensionPrefixList = ImmutableMap.<String, String>builder()
        .put("split_unit", "時速|分速|秒速|毎秒")
        .build();

    public static final List<String> DimensionAmbiguousValues = Arrays.asList("丈", "位", "克", "分", "升", "寸", "尺", "斗", "斤", "桶", "毫", "石", "码", "磅", "米", "罐", "里", "m", "km", "dm", "cm", "mm", "l", "ml", "kg", "mg", "g", "t", "b", "byte", "kb", "mb", "gb", "tb", "pb", "時速", "トン");
