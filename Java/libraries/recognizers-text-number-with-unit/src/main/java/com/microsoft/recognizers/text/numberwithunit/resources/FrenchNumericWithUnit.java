...
public class FrenchNumericWithUnit {
    ...
    public static final ImmutableMap<String, String> CurrencyNameToIsoCodeMap = ImmutableMap.<String, String>builder()
        ...
        .put("Kwanza angolais", "AOA")
        .put("Armenian dram", "AMD")
        .put("Florins d'Aruba", "AWG")
        .put("Bangladeshi taka", "BDT")
        .put("Ngultrum bhoutanais", "BTN")
        .put("Boliviano bolivien", "BOB")
        .put("Bosnie-Herzégovine mark convertible", "BAM")
        .put("Pula", "BWP")
        .put("Réal brésilien", "BRL")
        .put("Lev bulgare", "BGN")
        .put("Riel cambodgien", "KHR")
        .put("Escudo du cap-vert", "CVE")
        .put("Colon du costa rica", "CRC")
        .put("Kuna croate", "HRK")
        .put("Couronne tchèque", "CZK")
        .put("Nakfas érythréens", "ERN")
        .put("Birr éthiopien", "ETB")
        .put("Dalasi gambienne", "GMD")
        .put("Lari géorgien", "GEL")
        .put("Cedi", "GHS")
        .put("Quetzal guatémaltèque", "GTQ")
        .put("Gourdes haïtiennes", "HTG")
        .put("Lempira hondurien", "HNL")
        .put("Forint hongrois", "HUF")
        .put("Rial iranien", "IRR")
        .put("Yemeni rial", "YER")
        .put("Israeli new shekel", "ILS")
        .put("Yen Japonais", "JPY")
        .put("Tenge kazakh", "KZT")
        .put("Shilling kényan", "KES")
        .put("Corée du nord won", "KPW")
        .put("Won sud-coréen", "KRW")
        .put("Som Kirghizie", "KGS")
        .put("Kip laotien", "LAK")
        .put("Loti", "LSL")
        .put("Rand sud-africain", "ZAR")
        .put("Pataca macanais", "MOP")
        .put("Dinar macédonien", "MKD")
        .put("Ariary malagache", "MGA")
        .put("Kwacha malawien", "MWK")
        .put("Ringitt malaisien", "MYR")
        .put("Ouguiya mauritanienne", "MRO")
        .put("Togrogs mongoles", "MNT")
        .put("Metical mozambique", "MZN")
        .put("Kyat birmanie", "MMK")
        .put("Cordoba nicaraguayen", "NIO")
        .put("Nigerian naira", "NGN")
        .put("Livre turque", "TRY")
        .put("Rials omanais", "OMR")
        .put("Balboa panaméennes", "PAB")
        .put("Kina", "PGK")
        .put("Guaraní paraguayen", "PYG")
        .put("Peruvian sol", "PEN")
        .put("Złoty polonais", "PLN")
        .put("Riyal qatari", "QAR")
        .put("Riyal saudi", "SAR")
        .put("Tala", "WST")
        .put("São Tomé and Príncipe dobra", "STN")
        .put("Leone", "SLL")
        .put("Lilangeni", "SZL")
        .put("Somoni tadjikistan", "TJS")
        .put("Baht thaïlandais", "THB")
        .put("Hryvnia ukrainien", "UAH")
        .put("Vanuatu vatu", "VUV")
        .put("Bolívar vénézuélien", "VEF")
        .put("Kwacha de Zambie", "ZMW")
        .put("Dirham marocain", "MAD")
        .put("Dirham des Émirats arabes unis", "AED")
        .put("Manat azerbaïdjanais", "AZN")
        .put("Manat turkmène", "TMT")
        .put("Shilling somalien", "SOS")
        .put("Shilling tanzanien", "TZS")
        .put("Shilling ougandais", "UGX")
        .put("Leu roumain", "RON")
        .put("Leu moldave", "MDL")
        .put("Roupie népalaise", "NPR")
        .put("Roupie pakistanaise", "PKR")
        .put("Roupie indienne", "INR")
        .put("Roupie seychelloise", "SCR")
        .put("Roupie mauricienne", "MUR")
        .put("Rufiyaa maldives", "MVR")
        .put("Sri Lankan rupee", "LKR")
        .put("Rupiah Indonésie", "IDR")
        .put("Couronne danoise", "DKK")
        .put("Couronne norvégienne", "NOK")
        .put("Icelandic króna", "ISK")
        .put("Couronne suédoise", "SEK")
        .put("Franc CFA de l'Afrique de l'Ouest", "XOF")
        .put("Franc CFA d'Afrique centrale", "XAF")
        .put("Franc comorien", "KMF")
        .put("Franc congolais", "CDF")
        .put("Franc burundais", "BIF")
        .put("Franc djiboutienne", "DJF")
        .put("Franc CFP", "XPF")
        .put("Franc guinéen", "GNF")
        .put("Franc Suisse", "CHF")
        .put("Franc rwandais", "RWF")
        .put("Rouble russe", "RUB")
        .put("Rouble transnistriens", "PRB")
        .put("Nouveau rouble biélorusse", "BYN")
        .put("Dinar algérien", "DZD")
        .put("Dinar de bahreïn", "BHD")
        .put("Dinar iraquien", "IQD")
        .put("Dinar jordanien", "JOD")
        .put("Dinar koweïtien", "KWD")
        .put("Dinar libyen", "LYD")
        .put("Dinar serbe", "RSD")
        .put("Dinar tunisien", "TND")
        .put("Peso argentin", "ARS")
        .put("Peso chilien", "CLP")
        .put("Peso colombien", "COP")
        .put("Peso cubains convertibles", "CUC")
        .put("Peso cubains", "CUP")
        .put("Peso dominicain", "DOP")
        .put("Mexican peso", "MXN")
        .put("Peso uruguayen", "UYU")
        .put("Livre britannique", "GBP")
        .put("Livre sainte-hélène", "SHP")
        .put("Livre égyptienne", "EGP")
        .put("Livre des îles falkland", "FKP")
        .put("Livre gibraltar", "GIP")
        .put("Livre manx", "IMP")
        .put("Livre jersey", "JEP")
        .put("Livre libanaise", "LBP")
        .put("South Sudanese pound", "SSP")
        .put("Livre soudanaise", "SDG")
        .put("Livre syrienne", "SYP")
        ...
        .put("Dollar libérien", "LRD")
        .put("Dollar namibien", "NAD")
        .put("Dollar des îles Salomon", "SBD")
        .put("Dollar du suriname", "SRD")
        .put("Nouveau dollar de Taïwan", "TWD")
        .put("Dollar trinidadien", "TTD")
        .put("Tuvaluan dollar", "TVD")
        .put("Yuan Chinois", "CNY")
        .put("Rial", "__RI")
        .put("Shiling", "__S")
        .put("Som", "__SO")
        .put("Dirham", "__DR")
    ...
    public static final String CompoundUnitConnectorRegex = "(?<spacer>et)";
