...
public class EnglishTimeZone {
    ...
    public static final ImmutableMap<String, Integer> FullToMinMapping = ImmutableMap.<String, Integer>builder()
        ...
        .put("central", -300)
        .put("central time", -300)
        .put("central timezone", -300)
        .put("eastern", -240)
        .put("eastern time", -240)
        .put("eastern timezone", -240)
        ...
        .put("mountain", -360)
        .put("mountain time", -360)
        .put("mountain timezone", -360)
        ...
        .put("pacific", -420)
        .put("west coast", -420)
        .put("west coast time", -420)
        .put("west coast timezone", -420)
        ...
        .put("australian western daylight time", 540)
        .put("australian west daylight time", 540)
