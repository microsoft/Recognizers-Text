...
namespace Microsoft.Recognizers.Text.Number.Spanish.Extractors
{
    public class IntegerExtractor : BaseNumberExtractor
    {
        ...
        public const string RoundNumberIntegerRegex = @"(mil|millones|mill[oó]n|billones|bill[oó]n|trillones|trill[oó]n|cuatrillones|cuatrill[oó]n|quintillones|quintill[oó]n|sextillones|sextill[oó]n|septillones|septill[oó]n)";
