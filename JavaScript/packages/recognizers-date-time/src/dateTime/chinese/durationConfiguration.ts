import { ExtractResult } from "recognizers-text-base";
import { RegExpUtility, CultureInfo, Culture, BaseNumberExtractor, BaseNumberParser } from "recognizers-text-number";
