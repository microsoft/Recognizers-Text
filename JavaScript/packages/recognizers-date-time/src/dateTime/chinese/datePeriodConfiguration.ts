...
class ChineseDatePeriodExtractorConfiguration implements IDatePeriodExtractorConfiguration {
    ...
    constructor() {
        this.simpleCasesRegexes = [
            ...
            RegExpUtility.getSafeRegExp(ChineseDateTime.YearToYearSuffixRequiredRegex),
...
export class ChineseDatePeriodParser extends BaseDatePeriodParser {
    ...
    private readonly YearToYearSuffixRequiredRegex: RegExp;
    ...
    constructor() {
        ...
        this.YearToYearSuffixRequiredRegex = RegExpUtility.getSafeRegExp(ChineseDateTime.YearToYearSuffixRequiredRegex);
    ...
    private parseYearToYear(source: string, referenceDate: Date): DateTimeResolutionResult {
        ...
        if (!match) {
            let match = RegExpUtility.getMatches(this.YearToYearSuffixRequiredRegex, source).pop();
            if (!match) {
                return result;
            }
        }
