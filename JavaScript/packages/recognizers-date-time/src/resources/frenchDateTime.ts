...
export namespace FrenchDateTime {
	...
	export const HourNumRegex = `\\b(?<hournum>zero|un|deux|trois|quatre|cinq|six|sept|huit|neuf|onze|douze|treize|quatorze|quinze|dix-six|dix-sept|dix-huit|dix-neuf|vingt|vingt-et-un|vingt-deux|vingt-trois|dix)\\b`;
	...
	export const PrepositionRegex = `(?<prep>^([aà] la|[aà]|en|sur\\s*l[ea]|sur|de)$)`;
