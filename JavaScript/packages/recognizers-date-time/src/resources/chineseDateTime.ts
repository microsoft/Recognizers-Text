...
export namespace ChineseDateTime {
    ...
    export const DateDayRegexInChinese = `(?<day>(([12][0-9]|3[01]|[1-9]|[三叁][十拾][一壹]?|[二贰貳]?[十拾](${OneToNineIntegerRegex})?|${OneToNineIntegerRegex})[日号]|初一|三十))`;
    export const DayRegexNumInChinese = `(?<day>[12][0-9]|3[01]|[1-9]|[三叁][十拾][一壹]?|[二贰貳]?[十拾](${OneToNineIntegerRegex})?|${OneToNineIntegerRegex}|廿|卅)`;
    ...
    export const DynastyYearRegex = `(?<dynasty>${RegionTitleRegex})(?<biasYear>(${DynastyStartYear}|\\d{1,3}|[十拾]?(${ZeroToNineIntegerRegexChs}[十百拾佰]?){0,3}))`;
    export const DateYearInChineseRegex = `(?<yearchs>(${ZeroToNineIntegerRegexChs}${ZeroToNineIntegerRegexChs}${ZeroToNineIntegerRegexChs}${ZeroToNineIntegerRegexChs}|${ZeroToNineIntegerRegexChs}${ZeroToNineIntegerRegexChs}|${ZeroToNineIntegerRegexChs}${ZeroToNineIntegerRegexChs}${ZeroToNineIntegerRegexChs}|${DynastyYearRegex}))`;
    ...
    export const DateRegexList6 = `${MonthNumRegex}\\s*[/\\\\\\-]\\s*${DayRegex}\\s*[/\\\\\\-]\\s*${SimpleYearRegex}(?!\\s*[/\\\\\\-\\.]\\s*\\d+)`;
    export const DateRegexList7 = `${DayRegex}\\s*[/\\\\\\-\\.]\\s*${MonthNumRegex}\\s*[/\\\\\\-\\.]\\s*${YearNumRegex}(?!\\s*[/\\\\\\-\\.]\\s*\\d+)`;
    export const DateRegexList8 = `${YearNumRegex}\\s*[/\\\\\\-\\. ]\\s*${MonthNumRegex}\\s*[/\\\\\\-\\. ]\\s*${DayRegex}(?!\\s*[/\\\\\\-\\.]\\s*\\d+)`;
    ...
    export const DatePeriodYearInChineseRegex = `${DateYearInChineseRegex}年${HalfYearRegex}?`;
    ...
    export const YearAndMonth = `(${DatePeriodYearInChineseRegex}|${YearRegex})\\s*${MonthRegex}`;
    ...
    export const YearToYear = `(${DateRangePrepositions})(${DatePeriodYearInChineseRegex}|${YearRegex})\\s*(${DatePeriodTillRegex}|后|後|之后|之後)\\s*(${DatePeriodYearInChineseRegex}|${YearRegex})(\\s*((之间|之内|期间|中间|间)|前|之前))?`;
    export const YearToYearSuffixRequired = `(${DateRangePrepositions})(${DatePeriodYearInChineseRegex}|${YearRegex})\\s*(${DatePeriodTillSuffixRequiredRegex})\\s*(${DatePeriodYearInChineseRegex}|${YearRegex})\\s*(之间|之内|期间|中间|间)`;
