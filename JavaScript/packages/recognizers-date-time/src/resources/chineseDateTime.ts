...
export namespace ChineseDateTime {
    ...
    export const AfterRegex = `以后|以後|之后|之後|后|後|还剩`;
    export const TimePeriodLeftRegex = `还剩`;
    ...
    export const DatePointWithAgoAndLater = `^[.]`;
    ...
    export const WeekOfDateRegex = `^[.]`;
    export const MonthOfDateRegex = `^[.]`;
    ...
    export const TimeOfSpecialDayRegex = `(今晚|今早|今晨|明晚|明早|明晨|昨晚)(的|在)?`;
    ...
    export const ConnectorRegex = `^\\s*,\\s*$`;
    ...
    export const ParserConfigurationLastWeekDayRegex = `最后一个`;
    export const ParserConfigurationNextMonthRegex = `下一个`;
    export const ParserConfigurationLastMonthRegex = `上一个`;
