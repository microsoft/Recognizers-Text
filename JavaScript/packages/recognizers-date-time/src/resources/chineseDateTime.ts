...
export namespace ChineseDateTime {
	...
	export const DatePeriodTillRegex = `(?<till>与|和|到|至|--|-|—|——|~|–)`;
	...
	export const YearToYear = `((从|在|自)\\s*)?(${DatePeriodYearInChineseRegex}|${DatePeriodYearRegex})\\s*${DatePeriodTillRegex}\\s*(${DatePeriodYearInChineseRegex}|${DatePeriodYearRegex})(\\s*(之间|之内|期间|中间|间))?`;
