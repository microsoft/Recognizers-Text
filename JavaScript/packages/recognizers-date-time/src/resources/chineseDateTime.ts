...
export namespace ChineseDateTime {
	...
	export const DatePeriodTillSuffixRequired = `(?<till>与|和)`;
	...
	export const YearToYearSuffixRequired = `((从|在|自)\\s*)?(${DatePeriodYearInChineseRegex}|${DatePeriodYearRegex})\\s*(${DatePeriodTillSuffixRequired})\\s*(${DatePeriodYearInChineseRegex}|${DatePeriodYearRegex})\\s*(之间|之内|期间|中间|间)`;
	export const MonthToMonth = `(${MonthRegex})${DatePeriodTillRegex}(${MonthRegex})`;
	export const MonthToMonthSuffixRequired = `(${MonthRegex})${DatePeriodTillSuffixRequired}(${MonthRegex})\\s*(之间|之内|期间|中间|间)`;
