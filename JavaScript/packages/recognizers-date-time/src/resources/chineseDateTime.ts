...
export namespace ChineseDateTime {
	...
	export const DatePeriodTillDependenceRegex = `(?<till>与|和)`;
	...
	export const YearToYearDependence = `((从|在|自)\\s*)?(${DatePeriodYearInChineseRegex}|${DatePeriodYearRegex})\\s*(${DatePeriodTillDependenceRegex})\\s*(${DatePeriodYearInChineseRegex}|${DatePeriodYearRegex})\\s*(之间|之内|期间|中间|间)`;
	export const MonthToMonth = `(${MonthRegex})${DatePeriodTillRegex}(${MonthRegex})`;
	export const MonthToMonthDependence = `(${MonthRegex})${DatePeriodTillDependenceRegex}(${MonthRegex})\\s*(之间|之内|期间|中间|间)`;
