...
export namespace EnglishDateTime {
    ...
    export const DateExtractor6 = `(?<=${DatePreposition}\\s+)(${StrictRelativeRegex}\\s+)?(${WeekDayRegex}\\s+)?${MonthNumRegex}[\\-\\.]${DayRegex}(?![%]|\\.\\d)\\b`;
    export const DateExtractor7L = `\\b(${WeekDayRegex}\\s+)?(?<!\\.)${MonthNumRegex}\\s*/\\s*${DayRegex}${DateExtractorYearTermRegex}(?![%]|\\.\\d)\\b`;
    export const DateExtractor7S = `\\b(${WeekDayRegex}\\s+)?(?<!\\.)${MonthNumRegex}\\s*/\\s*${DayRegex}(?![%]|\\.\\d)\\b`;
    export const DateExtractor8 = `(?<=${DatePreposition}\\s+)(${StrictRelativeRegex}\\s+)?(${WeekDayRegex}\\s+)?${DayRegex}[\\\\\\-]${MonthNumRegex}(?![%]|\\.\\d)\\b`;
    export const DateExtractor9L = `\\b(${WeekDayRegex}\\s+)?(?<!\\.)${DayRegex}\\s*/\\s*${MonthNumRegex}${DateExtractorYearTermRegex}(?![%]|\\.\\d)\\b`;
    export const DateExtractor9S = `\\b(${WeekDayRegex}\\s+)?(?<!\\.)${DayRegex}\\s*/\\s*${MonthNumRegex}(?![%]|\\.\\d)\\b`;
