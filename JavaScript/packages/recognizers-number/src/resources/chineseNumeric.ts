...
export namespace ChineseNumeric {
    ...
    export const RoundNumberIntegerRegex = `(((?<![十百千拾佰仟])[十百千拾佰仟])|([万亿兆萬億]{1,2}))`;
    ...
    export const NotSingleRegex = `(((${DigitNumPlusRegex}|[十拾])\\s*(\\s*[多几幾余]?\\s*${RoundNumberIntegerRegex}){1,2}|[十拾]|${RoundNumberIntegerRegex}\\s*${ZeroToNineIntegerRegex})\\s*|${ZeroToNineFullHalfRegex})((((${DigitNumPlusRegex})\\s*(\\s*[多几幾余]?\\s*${RoundNumberIntegerRegex}){1,2}|零)\\s*)|(${ZeroToNineFullHalfRegex}))*(${DigitNumPlusRegex})?`;
    export const SingleRegex = `(?<!${ZeroToNineIntegerRegex})${ZeroToNineIntegerRegex}(?=${AllowListRegex})`;
    export const AllIntRegex = `((((${DigitNumPlusRegex}|[十拾])\\s*(\\s*[多几幾余]?\\s*${RoundNumberIntegerRegex}){1,2}|[十拾]|${RoundNumberIntegerRegex}\\s*${ZeroToNineIntegerRegex})\\s*|${ZeroToNineFullHalfRegex})((((${DigitNumPlusRegex})\\s*(\\s*[多几幾余]?\\s*${RoundNumberIntegerRegex}){1,2}|零)\\s*)|(${ZeroToNineFullHalfRegex}))*(${DigitNumPlusRegex})?|(${DigitNumPlusRegex}))`;
