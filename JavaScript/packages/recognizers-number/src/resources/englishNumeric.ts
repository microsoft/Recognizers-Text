...
export namespace EnglishNumeric {
	...
	export const RelativeOrdinalFilterRegex = `(?<!(-|(april|apr|august|aug|december|dec|february|feb|january|jan|july|jul|june|jun|march|mar|may|november|nov|october|oct|september|sept|sep)\\s*))(first|${RelativeOrdinalRegex})\\s*(${TwoToNineIntegerRegex}|[2-9]+)(?!\\s*${RoundNumberIntegerRegex})`;
