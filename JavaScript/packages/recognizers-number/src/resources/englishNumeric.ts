...
export namespace EnglishNumeric {
	...
	export const RelativeOrdinalRegex = `(last|next one|previous one)`;
	...
	export const RelativeReferenceMap: ReadonlyMap<string, string> = new Map<string, string>([["last", "N"],["next one", "CURR + 1"],["previous one", "CURR - 1"]]);
}
