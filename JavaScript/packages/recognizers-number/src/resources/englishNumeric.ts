...
export namespace EnglishNumeric {
	...
	export const RelativeOrdinalRegex = `(last|next one|previous one|the second to last|the one before the last one|next to last|penultimate|the last but one|antepenultimate|next)`;
	...
	export const RelativeReferenceMap: ReadonlyMap<string, string> = new Map<string, string>([["last", "N"],["next one", "CURR+1"],["previous one", "CURR-1"],["the second to last", "CURR-1"],["the one before the last one", "CURR-1"],["next to last", "CURR-1"],["penultimate", "CURR-1"],["the last but one", "CURR-1"],["antepenultimate", "CURR-2"],["next", "CURR+1"]]);
}
