...
import { Culture, CultureInfo, NumberMode, AgnosticNumberParserFactory, AgnosticNumberParserType, ChineseNumberExtractor, ChineseNumberParserConfiguration, NumberOptions } from "@microsoft/recognizers-text-number";
...
export abstract class ChineseNumberWithUnitExtractorConfiguration implements INumberWithUnitExtractorConfiguration {
    ...
    constructor(ci: CultureInfo) {
        this.cultureInfo = ci;
        this.unitNumExtractor = new ChineseNumberExtractor(NumberOptions.ChineseNumbersWithPercent);
...
export class ChineseNumberWithUnitParserConfiguration extends BaseNumberWithUnitParserConfiguration {
    ...
    constructor(ci: CultureInfo) {
        ...
        this.internalNumberExtractor = new ChineseNumberExtractor(NumberOptions.None);
