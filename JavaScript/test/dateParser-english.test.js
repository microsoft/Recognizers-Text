...
describe('Date Parser', it => {
    ...
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back Oct. 2", new Date(tYear + 1, 10, 2), new Date(tYear, 10, 2));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back Oct-2", new Date(tYear + 1, 10, 2), new Date(tYear, 10, 2));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back Oct/2", new Date(tYear + 1, 10, 2), new Date(tYear, 10, 2));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back October. 2", new Date(tYear + 1, 10, 2), new Date(tYear, 10, 2));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back January 12, 2016", new Date(2016, 1, 12), new Date(2016, 1, 12));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back on 4.22", new Date(tYear + 1, 4, 22), new Date(tYear, 4, 22));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back on 4-22", new Date(tYear + 1, 4, 22), new Date(tYear, 4, 22));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back in 4.22", new Date(tYear + 1, 4, 22), new Date(tYear, 4, 22));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back at 4-22", new Date(tYear + 1, 4, 22), new Date(tYear, 4, 22));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back on    4/22", new Date(tYear + 1, 4, 22), new Date(tYear, 4, 22));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back on 22/04", new Date(tYear + 1, 4, 22), new Date(tYear, 4, 22));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back     4/22", new Date(tYear + 1, 4, 22), new Date(tYear, 4, 22));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back 22/04", new Date(tYear + 1, 4, 22), new Date(tYear, 4, 22));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back 1st Jan", new Date(tYear + 1, 1, 1), new Date(tYear, 1, 1));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back Jan-1", new Date(tYear + 1, 1, 1), new Date(tYear, 1, 1));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back Wed, 22 of Jan", new Date(tYear + 1, 1, 22), new Date(tYear, 1, 22));
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back Monday January 12th, 2016", new Date(2016, 1, 12));
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back 02/22/2016", new Date(2016, 2, 22));
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back 21/04/2016", new Date(2016, 4, 21));
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back 21/04/16", new Date(2016, 4, 21));
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back 21-04-2016", new Date(2016, 4, 21));
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back 2015/08/12", new Date(2015, 8, 12));
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back 08/12,2015", new Date(2015, 8, 12));
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back 08/12,15", new Date(2015, 8, 12));

    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back Jan first", new Date(tYear + 1, 1, 1), new Date(tYear, 1, 1));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back May twenty-first", new Date(tYear + 1, 5, 21), new Date(tYear, 5, 21));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back May twenty one", new Date(tYear + 1, 5, 21), new Date(tYear, 5, 21));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back second of Aug.", new Date(tYear + 1, 8, 2), new Date(tYear, 8, 2));
    BasicTestWithFutureAndPast(it, extractor, parser, referenceDate, "I'll go back twenty second of June", new Date(tYear + 1, 6, 22), new Date(tYear, 6, 22));
    ...
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back 15 June 2016", new Date(2016, 6, 15));
    ...
    BasicTestWithOneDate(it, extractor, parser, referenceDate, "I'll go back in two weeks", new Date(2016, 10, 21));
...
describe('Date Parser LUIS', it => {
    ...
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back today", "2016-10-07");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back tomorrow", "2016-10-08");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back yesterday", "2016-10-06");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back the day before yesterday", "2016-10-05");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back the day after tomorrow", "2016-10-09");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "The day after tomorrow", "2016-10-09");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back the next day", "2016-10-08");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back next day", "2016-10-08");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back this Friday", "2016-10-11");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back next Sunday", "2016-10-20");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back the day", "2016-10-07");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back 15 June 2016", "2016-06-15");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I went back two days ago", "2016-10-05");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I went back two years ago", "2014-10-07");

    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back in two weeks", "2016-10-21");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back two weeks from now", "2016-10-21");

    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back next week on Friday", "2016-10-18");
    BasicTestWithLUIS(it, extractor, parser, referenceDate, "I'll go back on Friday next week", "2016-10-18");
});
