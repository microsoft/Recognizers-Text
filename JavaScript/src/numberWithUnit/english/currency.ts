...
export class EnglishCurrencyExtractorConfiguration extends EnglishNumberWithUnitExtractorConfiguration {
    ...
    constructor(ci?: CultureInfo) {
        ...
        this.suffixList = EnglishCurrencyExtractorConfiguration.currencySuffixList();

        this.prefixList = EnglishCurrencyExtractorConfiguration.currencyPrefixList();
    ...
    static currencySuffixList(): ReadonlyMap<string, string> {
    ...
    static currencyPrefixList(): ReadonlyMap<string, string> {
        return new Map<string, string>([
            ["Dollar", "$"],
...
export class EnglishCurrencyParserConfiguration extends EnglishNumberWithUnitParserConfiguration {
    constructor(ci?: CultureInfo) {
        ...
        this.BindDictionary(EnglishCurrencyExtractorConfiguration.currencySuffixList());
        this.BindDictionary(EnglishCurrencyExtractorConfiguration.currencyPrefixList());
    }
}